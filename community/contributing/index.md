...
If in doubt about where to start, check the contributing guide from [Camel Core](../../camel-core/contributing/index.md), which provides the overall guidelines for the project and contains comprehensive documentation that may apply for the subprojects.

Please note that each subproject may have its own specific development process, coding conventions, and contribution workflows. It is crucial to carefully review the respective guidelines to ensure your contributions align with the subproject’s standards and expectations.
