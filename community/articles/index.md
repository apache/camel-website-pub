...
-   [Monitoring Camel with Prometheus in OpenShift](https://brunonetid.github.io/2017/11/27/camel-prometheus-openshift.md) from November 2017 by Bruno Meseguer talks about how to gather Camel metrics using Prometheus and display in Grafana.
...
-   There are several companies that provide extra documentation, examples, tutorials, etc… See the [Commercial Camel Offerings](../../manual/commercial-camel-offerings.md) page for more details.