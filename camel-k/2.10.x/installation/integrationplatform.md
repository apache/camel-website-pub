...
There are many more configuration available in the IntegrationPlatform specification. Have a look at the [IntegrationPlatform API specification](../apis/camel-k.html#_camel_apache_org_v1_IntegrationPlatformSpec) to learn more about each of its usage.

Have also a look at the specific sections to learn more about [how to configure a container registry](registry/registry.md), [how to choose the right build and publishing strategy](advanced/build-config.md) or [how to configure Maven](advanced/maven.md).