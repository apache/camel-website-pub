...
$ kubectl apply -k github.com/apache/camel-k/install/overlays/kubernetes/descoped?ref=v2.10.1  --server-side --force-conflicts

## Upgrade via Operator Hub

Upgrading via [Operator Hub](https://operatorhub.io/) may be automatically done by the cluster if this option was set at installation time. If not, you need to follow the instructions in the [Camel K Operator Hub](https://operatorhub.io/operator/camel-k) page.
