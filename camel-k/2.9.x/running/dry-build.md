...
This feature will fit into the rest of build features such as [Git hosted Integrations](build-from-git.md), [self managed Integrations](self-managed.md) and [environment promotions](promoting.md).