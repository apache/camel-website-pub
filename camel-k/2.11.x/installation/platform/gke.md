...
Before installing Camel K on a fresh GKE cluster, you need to perform some extra steps to give to your account the required cluster-admin permissions. This means executing the following command (**replacing "[your-address@gmail.com](mailto:your-address@gmail.com)" with your account email address**):
...
The last thing to do is to [configure gcr.io as registry](../registry/special/gcr.md) to host your integration image.