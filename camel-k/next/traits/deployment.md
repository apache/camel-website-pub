...
| `deployment.progressDeadlineSeconds` | `int32` | The maximum time in seconds for the deployment to make progress before it is considered to be failed. It defaults to `60s`. |
