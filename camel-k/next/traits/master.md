...
| --- | --- | --- |
| `master.resource-name` | `quarkus.camel.cluster.kubernetes.resource-name` | Name of the lock resource |
| `master.resource-type` | `quarkus.camel.cluster.kubernetes.resource-type` | Type of Kubernetes resource (Lease or ConfigMap) |
| `master.label-key / master.label-value` | `quarkus.camel.cluster.kubernetes.labels."<key>"` | Labels for pod identification |
