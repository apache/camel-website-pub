...
| Name | Description | Default |
| --- | --- | --- |
| MAVEN\_SETTINGS | Configmap or Secret Maven `settings.xml` configuration used to define repositories, mirrors, and credentials. |  |
| MAVEN\_SETTINGS\_SECURITY | Configmap or Secret Maven `settings-security.xml` configuration used for decrypting encrypted credentials in `settings.xml`. |  |
