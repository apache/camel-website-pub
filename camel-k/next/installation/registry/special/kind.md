...
> **Note**
> The content of this script is based on [the official script](https://kind.sigs.k8s.io/docs/user/local-registry/) but with some slight changes to adapt it to Camel-K.
...
```none
REGISTRY_ADDRESS: kind-registry:5000
