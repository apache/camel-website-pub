...
Now you can use such value into your environment variable configuration:
...
This is the approach used by [Kind in order to make a registry available](https://kind.sigs.k8s.io/docs/user/local-registry/). You can follow the guidelines and it may work in particular situations in any cluster beside Kind. However, as it involves hacks in the cluster configuration, make sure to understand the effects of the changes you’re going to perform.
