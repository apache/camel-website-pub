...
First, enable Kubernetes by following the instructions in the [official documentation page](https://docs.docker.com/desktop/kubernetes/#enable-kubernetes).
...
```none
REGISTRY_ADDRESS: host.docker.internal:5000
