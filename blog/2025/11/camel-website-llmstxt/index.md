...
Published 2025-11-12 by Federico Mariani in Tooling

How we implemented llms.txt to make Apache Camel documentation easily accessible to AI coding agents and LLM training
...
**User:** Reply to Apache Camel-related questions using the llms.txt `https://camel.apache.org/llms.txt` follow links and redirect. What is the latest Camel release? And the latest Camel Quarkus?
...
-   **HTML**: `https://camel.apache.org/components/4.10.x/languages/simple-language.md`
-   **Markdown**: `https://camel.apache.org/components/4.10.x/languages/simple-language.md.md`
