...
Published 2025-03-05 by Pasquale Congiusti in Howtos

How to leverage Camel Observability Services component
...
The term _Observability_ is often used with a wide perspective and may provide misunderstanding about what it really encompass. When we talk about observability in Camel we typically refer to four main areas: _metrics_, _health_, _logs_ and _traces_.
...
The two “standard” technology we are using are [Micrometer Prometheus](https://docs.micrometer.io/micrometer/reference/implementations/prometheus.md) (for metrics) and [OpenTelemetry](https://opentelemetry.io/) (for traces).
