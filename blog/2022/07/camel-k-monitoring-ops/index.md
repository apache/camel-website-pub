...
Published 2022-07-05 by Pasquale Congiusti in Camel K

Camel K: how to monitor an Integration and get alerts
...
You can start calling your endpoint in order to simulate some traffic. A nice way to put your system under stress is to use `ab` tool from [Apache Benchmark](https://httpd.apache.org/docs/2.4/programs/ab.md). Let’s create ten thousands of requests to our service:
