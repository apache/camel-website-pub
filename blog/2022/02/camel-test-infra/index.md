...
Published 2022-02-16 by Otavio Rodolfo Piske in Camel

Good bye camel-testcontainers! Hello Camel's test-infra

For Camel 3.16.0 we are removing the deprecated container-based test modules and replacing them with a new set of modules called Camel [test-infra](../../../../manual/test-infra.md).
...
To help users to migrate, we have written an extensive manual for the [test-infra](../../../../manual/test-infra.md). If you find an issue with these modules, don’t hesitate to [report an issue](https://issues.apache.org/jira) or provide a [contribution](https://github.com/apache/camel) to Apache Camel.