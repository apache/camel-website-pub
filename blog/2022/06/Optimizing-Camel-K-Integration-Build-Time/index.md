...
Published 2022-06-28 by Subhasmita Swain, Antonin Stefanutti in Camel K

Scaling the Camel K operator vertically to improve the integration build time.
...
_PS: These metrics are exclusive to my system; they may differ for others._
...
4.  Get the build duration The build duration is ~6mins using default usage of cores available.
...
8.  Get the build duration The build duration is ~2mins utilizing the maximum CPU cores available for my system.
...
Feedback or questions can be sent to the [camel-k](https://github.com/apache/camel-k) community by raising issues/discussing your concerns in the [mailing list](../../../../community/mailing-list/index.md) or [IRC](https://camel.zulipchat.com/#) channels.