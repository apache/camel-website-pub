...
Published 2022-10-10 by Matteo Mortari in Camel Quarkus, Usecases

Content Based Routing using Quarkus as a development platform including Apache Camel, Drools DMN Engine, Kogito, AtlasMap and Apache Kafka!

[YouTube Video](https://www.youtube-nocookie.com/embed/nXyKM-xds2M)

  
In this post I want to share with you how to implement a complete, end-to-end \*\*Content Based Routing\*\* solution using \[Apache Camel\](/#apache-camel-projects), \[AtlasMap\](https://www.atlasmap.io/) and \[Quarkus\](https://quarkus.io/) as a developer platform, including: \[Drools DMN Engine\](https://www.drools.org/learn/dmn.md), \[Kogito\](https://kogito.kie.org/). Apache Kafka is used in this solution as a message broker.
...
In a [separate post](https://blog.kie.org/2022/01/data-enrichment-use-case-with-dmn-and-bpmn.md) about Data Enrichment, I previously hinted at the potentials in combining the capabilities of AltasMap with Drools DMN; I hope this tutorial now provides a very pragmatic example!

## Technical details

In this section, I want to highlight how the [Camel DSL](../../../../manual/dsl.md) allows to implement the EIP pattern very easily:
...
If you found this content useful, you might be interested to know this is a second iteration of a [previous post](https://blog.kie.org/2021/06/intelligent-kafka-message-routing-using-drools-dmn-engine-and-apache-camel.md), where I implemented EIP patterns using just Drools and Apache Camel. You can reference that for additional technical details about the integration of Camel and Drools thanks to Kogito. In this installment instead I wanted to expand on that, to finally share an end-to-end solution which could be easily deployed on the cloud!
