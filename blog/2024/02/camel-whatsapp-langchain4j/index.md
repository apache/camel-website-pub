...
Published 2024-02-19 by Federico Mariani in Usecases, AI

Build a conversational AI integration with Apache Camel, LangChain4j, and WhatsApp.
...
In this example, the model [GPT-3.5 Turbo](https://platform.openai.com/docs/models/gpt-3-5-turbo) is used, and the [camel core contribution documentation](../../../../camel-core/contributing/index.md) is used as an embedding, in this way it will be possible to have clear conversations about camel contributions.
...
This blog post shows how Apache Camel can be leveraged to integrate LLMs with bulletproof enterprise integration patterns, we just showed how few lines of code can implement such a complex use case. ![Demo](conversation.gif)