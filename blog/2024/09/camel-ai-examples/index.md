...
Published 2024-09-04 by Tadayoshi Sato in AI

Explore the possibilities of intelligent routing based on neural network model inference with Camel and DJL.

[Apache Camel AI](../../../../components/next/ai-summary.md) is a set of components that allow various AI-related technologies to be integrated with Camel.
...
-   [Integrate your AI models effortlessly with Apache Camel](../../../../blog/2024/02/camel-whatsapp-langchain4j/index.md) by Federico Mariani.
-   [Experimenting extraction from unstructured data with Apache Camel and LangChain4j](../../../../blog/2024/07/data-extraction-first-experiment/index.md) by Alexandre Gallice
...
The DJL component will be significantly improved in the coming Camel 4.8.0 LTS release [1](#fn:1). It will allow performing inference with models for those various applications.
...
The code can be run with [Camel JBang](../../../../manual/camel-jbang.md):
...
[https://github.com/megacamelus/camel-ai-examples/tree/main/image-to-text](https://github.com/megacamelus/camel-ai-examples/tree/main/image-to-text)
...
[https://github.com/megacamelus/camel-ai-examples/tree/main/speech-to-text](https://github.com/megacamelus/camel-ai-examples/tree/main/speech-to-text)
...
-   [PINTO\_model\_zoo](https://github.com/PINTO0309/PINTO_model_zoo)
...
1.  Actually, it has been already improved since 4.7.0. See: [Apache Camel 4.7 What’s new](../../../../blog/2024/07/camel47-whatsnew/index.md) [↩︎](#fnref:1)