...
Published 2026-03-03 by Rodrigo Serra Coelho in Usecases

How I built a Consul-native API Gateway on Apache Camel — and why it now bridges REST APIs and LLM agents via MCP.
