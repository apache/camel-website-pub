...
Published 2026-06-26 by Claus Ibsen in Features
...
A **topology diagram** is different. It shows the connections _between_ routes — how they are wired together via shared endpoints, and how they interact with external systems like Kafka brokers, HTTP services, and databases. Think of it as a bird’s-eye view of your entire integration application.
...
Integration applications are inherently about connections — between systems, services, and data flows. A route diagram shows you what happens _inside_ a route. A topology diagram shows you what happens _between_ routes. Together, they give you a complete picture of your integration application, from the high-level architecture down to the individual processors.
...
For full documentation, see the [Route Diagram](../../../../manual/route-diagram.md) page in the user manual.