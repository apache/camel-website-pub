...
Published 2026-08-07 by Zineb BENDHIBA, Federico Mariani, Jiří Ondrušek in AI, Camel

Camel 4.22 introduces a unified AI tool abstraction and a built-in MCP server. Define a tool once as a Camel route, and it works with LangChain4j, Spring AI, and OpenAI. Tag it, and any MCP-compatible AI agent can discover and call it over MCP.
...
-   **Camel Spring Boot** uses the [Spring AI MCP server](https://docs.spring.io/spring-ai/reference/api/mcp/mcp-server-boot-starter-docs.md). Camel tools coexist with Spring AI’s native `@McpTool` beans on the same server.
