...
Published 2026-04-17 by Claus Ibsen, Federico Mariani, Pasquale Congiusti, Tom Cunningham, Zineb BENDHIBA, Andrea Cosentino in Releases

Details of what we have done in the Camel 4.19 release.

Apache Camel 4.19 has just been [released](../../../../blog/2026/04/RELEASE-4.19.0/index.md).
...
The [upgrade guide](../../../../manual/camel-4x-upgrade-guide-4_19.md) has a lot of details on how to migrate your Camel application to Jackson 3.
...
The Camel MCP Server, [introduced as a Preview in 4.18](../../../../blog/2026/02/camel-jbang-mcp/index.md), received significant improvements in this release.
...
A full example using these transformers to build an AI email triage agent is available in [this blog post](../../../../blog/2026/04/email-triage-agent/index.md).
...
Make sure to read the [upgrade guide](../../../../manual/camel-4x-upgrade-guide-4_19.md) if you are upgrading from a previous Camel version.
