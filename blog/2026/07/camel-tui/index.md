# Introducing Camel TUI — A Terminal Dashboard for Apache Camel

Published 2026-07-27 by Claus Ibsen in Features

Camel TUI is an interactive terminal dashboard that gives you a live view of your Camel integrations — route topology, message tracing, error diagnosis, and AI agent integration, all from a single terminal window.
...
-   **Record** — record your terminal session as a `.tape` file for demos and documentation. Convert to animated GIF with [agg](https://github.com/asciinema/agg) or [VHS](https://github.com/charmbracelet/vhs).
...
For the full reference, see the [Camel TUI documentation](../../../../manual/camel-jbang-tui.md).
