...
Published 2023-04-04 by Marcin Grzejszczak in Howtos

Micrometer Observation: how to configure Distributed Tracing and Metrics
...
Apache Camel comes with an abstraction of a [`Tracer`](../../../../components/next/others/tracing.md). It automatically creates spans for Camel Routes.
