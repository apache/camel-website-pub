...
Published 2023-12-18 by Claus Ibsen, Gregor Zurowski, Otavio Rodolfo Piske, Aurélien Pupier, Andrea Cosentino in Releases

Details of what we have done in the Camel 4.3 release.
...
Added basic support for Java 21 virtual threads. Note this is experimental and there is more work to complete to have full support for virtual threads. More details at [threading model](../../../../manual/threading-model.md).
...
-   [https://github.com/apache/camel-kamelets-examples/tree/main/jbang/bean-builder](https://github.com/apache/camel-kamelets-examples/tree/main/jbang/bean-builder)
-   [https://github.com/apache/camel-kamelets-examples/tree/main/jbang/bean-inlined-code](https://github.com/apache/camel-kamelets-examples/tree/main/jbang/bean-inlined-code)
...
Another new functionality is the _live message transformer_ with the new `camel transform message` command. You can find detailed information in the [camel-jbang docs](../../../../manual/camel-jbang-transforming.html#_transforming_messages_data_mapping), a basic example is here [json transformation](https://github.com/apache/camel-kamelets-examples/tree/main/jbang/json-transform), and we have a [video recording on YouTube](https://www.youtube.com/watch?v=ntVRSBcBBLU).
...
Make sure to read the [upgrade guide](../../../../manual/camel-4x-upgrade-guide-4_3.md) if you are upgrading from a previous Camel version.
