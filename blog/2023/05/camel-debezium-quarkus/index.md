...
Published 2023-05-31 by Miguel Delgadillo in Camel

Capturing database change records using Apache Camel and Debezium
...
In addition, using Debezium with Camel allows you to not rely on an external Kafka cluster or configure _“Kafka Service Connectors”_. Instead, Debezium runs directly in the context of the application, capturing the same change events within the database.
...
Camel includes components for Debezium in its implementation which allows to use it inside Apache Camel as a consumer endpoint which allows running the [Debezium engine in an embedded way](https://debezium.io/documentation/reference/stable/development/engine.md) in the running instance of Camel.

Some of the components currently available are:

-   [Debezium MySQL Connector Component](../../../../components/next/debezium-mysql-component.md)
-   [Debezium PostgreSQL Connector Component](../../../../components/next/debezium-postgres-component.md)
-   [Debezium SQL Server Connector Component](../../../../components/next/debezium-sqlserver-component.md)
-   [Debezium MongoDB Connector Component](../../../../components/next/debezium-mongodb-component.md)
-   [Debezium Oracle Connector Component](../../../../components/next/debezium-oracle-component.md) (So far it is still not supported in Quarkus)
