...
Published 2020-01-02 by Rodrigo Serra Coelho in Usecases

How an API Gateway is implemented using Camel at the European Comission
...
[![Architecture Overview](../../../../blog/2020/01/capi-gateway/CAPI-Gateway_hud73b9e573d7701a7aa181343335ed036_101110_800x0_resize_q95_gaussian_3.png)](../../../../blog/2020/01/capi-gateway/CAPI-Gateway.png "Architecture Overview (Click to enlarge)")
...
The _toEndpoint_ contains the default configuration:
...
-   @Component @Scheduled _ThrottlingInspector_ - Periodically checks the traffic on the deployed API Path level
-   @Component @Scheduled _Running API’s_ - Periodically checks for API errors, candidates routes to suspend.
...
If you wish to enable security for your API (api.secured = true), then you will need to define a _client_. Your API ID will be added as an authority in the authorities list of your client.
...
It would be amazing to have feedback from the Apache Camel Community. If you have any questions, feel free to contact me. The repo is located at [https://github.com/rodrigoserracoelho/capi-gateway](https://github.com/rodrigoserracoelho/capi-gateway)