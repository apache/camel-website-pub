# Apache Camel Kafka Connector 0.5.0: What's New

Published 2020-09-14 by Andrea Cosentino, Andrea Tarocchi in Releases

Details of what we have done in the Camel Kafka Connector 0.5.0 release.
...
On the Archetypes side: the archetype provided to extend the current connectors is now able to use a parameter to specify what connector you want to extend. More information available at [Camel-Kafka-connector archetype documentation](../../../../camel-kafka-connector/next/user-guide/extending-connector/index.md).
...
Thanks to our users we found out we could improve the performance of Source connectors: more details at [https://github.com/apache/camel-kafka-connector/issues/414](https://github.com/apache/camel-kafka-connector/issues/414)
