...
Published 2020-12-16 by Claus Ibsen in Releases

Details of what we have done in the Camel 3.7 release.
...
The [csimple language](../../../../components/4.22.x/languages/csimple-language.md) is parsed into regular Java source code and compiled together with all the other source code, or compiled once during bootstrap via jOOR.

[![Compiled Simple Language](../../../../blog/2020/12/Camel37-Whatsnew/csimple-compiled_hu4d5e12aee96372297689a000f98965d9_15785_800x0_resize_q95_gaussian_3.png)](../../../../blog/2020/12/Camel37-Whatsnew/csimple-compiled.png "Compiled Simple Language (Click to enlarge)")

Compiled Simple Language (Click to enlarge)
...
[![Simple vs Compiled Simple](../../../../blog/2020/12/Camel37-Whatsnew/simple-csimple-performance_hue939fbfb2fdb9eba5d45f8f876f55df3_59799_800x0_resize_q95_gaussian.jpg)](../../../../blog/2020/12/Camel37-Whatsnew/simple-csimple-performance.jpg "Simple vs Compiled Simple (Click to enlarge)")

Simple vs Compiled Simple (Click to enlarge)

For more information about the compiled simple language and further break down of performance improvements then read [Claus blog post](http://www.davsclaus.com/2020/12/apache-camel-37-compiled-simple.md).
...
If you are more curious about how we did these optimizations and with some performance numbers, then [Claus wrote a blog post](http://www.davsclaus.com/2020/11/apache-camel-37-more-camel-core.md).

### Optimized components startup

The camel core has been optimized in Camel 3 to be small, slim, and fast on startup. This benefits [Camel Quarkus](../../../../camel-quarkus/next/index.md) which can do built time optimizations that take advantage of the optimized camel core.
...
By separating this into different JARs (camel-core-model, camel-core-reifier, camel-core-processor) then we ensure they are separated and this allows us to better do built time optimizations and dead code elimination via [Quarkus](https://quarkus.io/) and/or GraalVM.
...
After this it’s no longer possible to dynamically add new Camel routes. The lightweight mode is intended for microservice/serverless architectures, with a _closed world_ assumption.

### Autowiring components

The Camel components is now capable of autowiring by type. For example the [AWS2 SQS](../../../../components/next/aws2-sqs-component.md) components can automatically lookup in the registry if there is a single instance of `SqsClient`, and then pre configure itself.

We have marked up in the Camel documentation which component options supports this by showing _Autowired_ in bold in the description.

### Salesforce fixes

Our recent Camel committer [Jeremy Ross](https://github.com/jeremyross) did great work to improve and fix bugs in the [camel-salesforce component](../../../../components/next/salesforce-component.md). We expect more to come from him.
...
The new [camel-datasonnet](../../../../components/next/languages/datasonnet-language.md) component, is to be used for data transformation using the [DataSonnet](https://datasonnet.com/) standard.
...
Make sure to read the [upgrade guide](../../../../manual/camel-3x-upgrade-guide-3_7.md) if you are upgrading to this release from a previous Camel version.

## More details

The previous LTS release was Camel 3.4. We have blog posts for what’s new in [Camel 3.5](../../../../blog/2020/10/Camel36-Whatsnew/index.md) and [Camel 3.6](../../../../blog/2020/09/Camel35-Whatsnew/index.md) you may want to read to cover all news between the two LTS releases.
