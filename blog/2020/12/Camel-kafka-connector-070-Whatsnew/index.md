...
Published 2020-12-24 by Andrea Cosentino, Andrea Tarocchi in Releases

Details of what we have done in the Camel Kafka Connector 0.7.0 release.
...
We improved the integration tests by leveraging the really good work by [Otavio R. Piske](https://github.com/orpiske) on the camel-test-infra platform. We are now basing the integration on the camel-test-infra modules coming from the Camel release.
