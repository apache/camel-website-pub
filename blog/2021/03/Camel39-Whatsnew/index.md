# Apache Camel 3.9 What's New

Published 2021-03-29 by Claus Ibsen in Releases

Details of what we have done in the Camel 3.9 release.
...
If you have seen Java monitoring tools then they will show memory usage charts that has _saw tooth’s_ where objects are allocated and later reclaimed by the JVM garabage collector.

The diagrams below illustrate the same example of using Camel 3.8 vs 3.9

[![Camel 3.8](../../../../blog/2021/03/Camel39-Whatsnew/memory-camel38_hue939fbfb2fdb9eba5d45f8f876f55df3_83091_800x0_resize_q95_gaussian.jpg)](../../../../blog/2021/03/Camel39-Whatsnew/memory-camel38.jpg "Camel 3.8 (Click to enlarge)")

Camel 3.8 (Click to enlarge)

In Camel 3.8 597mb of objects is allocated by Camel in total (running 10 minute).

[![Camel 3.9](../../../../blog/2021/03/Camel39-Whatsnew/memory-camel39_hu1418fcb03999baf003713dc9ddbbd91a_167464_800x0_resize_q95_gaussian_3.png)](../../../../blog/2021/03/Camel39-Whatsnew/memory-camel39.png "Camel 3.9 (Click to enlarge)")

Camel 3.9 (Click to enlarge)

And in Camel 3.9 that is **ZERO**

For more details read [Claus blog post](http://www.davsclaus.com/2021/03/apache-camel-39-no-more-saw-tooth-jvm.md) which explains how this was done.
...
This little [example](https://github.com/apache/camel-examples/tree/master/examples/routeloader) shows using Java and XML routes together. You can drop a .ktn file in the [myroutes](https://github.com/apache/camel-examples/tree/master/examples/routeloader/src/main/resources/myroutes) directory and Camel will during startup compile the Kotlin route and add its routes to the running Camel.
...
Make sure to read the [upgrade guide](../../../../manual/camel-3x-upgrade-guide-3_9.md) if you are upgrading from a previous Camel version.
