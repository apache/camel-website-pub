...
Published 2021-06-29 by Claus Ibsen in Releases

Details of what we have done in the Camel 3.11 LTS release.
...
You can find an example with `camel-kamelet-main` at [https://github.com/apache/camel-examples/tree/main/examples/kamelet-main](https://github.com/apache/camel-examples/tree/main/examples/kamelet-main)
...
We added a `getSourceTimestamp` API on `Message` to get hold of the timestamp from the source of the message. The idea is to have a common API across all the Camel components that has a timestamp of the event (such as JMS, Kafka, AWS, File/FTP etc).
...
Make sure to read the [upgrade guide](../../../../manual/camel-3x-upgrade-guide-3_11.md) if you are upgrading from a previous Camel version.
...
-   [Camel 3.8 What’s New](../../../../blog/2021/02/Camel38-Whatsnew/index.md)
-   [Camel 3.9 What’s New](../../../../blog/2021/03/Camel39-Whatsnew/index.md)
-   [Camel 3.10 What’s New](../../../../blog/2021/05/Camel310-Whatsnew/index.md)