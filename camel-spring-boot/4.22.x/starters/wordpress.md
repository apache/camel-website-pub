...
-   [WordPress component](../../../components/4.22.x/wordpress-component.md), URI syntax: `wordpress:operation`
...
| camel.component.wordpress.criteria | The criteria to use with complex searches. This is a multi-value option with prefix: criteria. |  | Object> |
