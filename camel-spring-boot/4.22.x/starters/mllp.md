...
-   [MLLP component](../../../components/4.22.x/mllp-component.md), URI syntax: `mllp:hostname:port`
...
| camel.component.mllp.idle-timeout-strategy | decide what action to take when idle timeout occurs. Possible values are : RESET: set SO\_LINGER to 0 and reset the socket CLOSE: close the socket gracefully default is RESET. | reset | MllpIdleTimeoutStrategy |
