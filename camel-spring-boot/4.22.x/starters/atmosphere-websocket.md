...
-   [Atmosphere Websocket component](../../../components/4.22.x/atmosphere-websocket-component.md), URI syntax: `atmosphere-websocket:servicePath`
...
| camel.component.atmosphere-websocket.mute-exception | If enabled and an Exchange failed processing on the consumer side the response’s body won’t contain the exception’s stack trace. | true | Boolean |
