...
-   [AWS Elastic Kubernetes Service (EKS) component](../../../components/4.22.x/aws2-eks-component.md), URI syntax: `aws2-eks:label`
...
| camel.component.aws2-eks.profile-credentials-name | If using a profile credentials provider, this parameter will set the profile name |  | String |
