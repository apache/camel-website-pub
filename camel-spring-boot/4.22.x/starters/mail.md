...
-   [IMAP component](../../../components/4.22.x/mail-component.md), URI syntax: `imap:host:port`
    
-   [IMAPS (Secure) component](../../../components/4.22.x/mail-component.md), URI syntax: `imaps:host:port`
    
-   [MIME Multipart data format](../../../components/4.22.x/dataformats/mimeMultipart-dataformat.md)
    
-   [POP3 component](../../../components/4.22.x/mail-component.md), URI syntax: `pop3:host:port`
    
-   [POP3S component](../../../components/4.22.x/mail-component.md), URI syntax: `pop3s:host:port`
    
-   [SMTP component](../../../components/4.22.x/mail-component.md), URI syntax: `smtp:host:port`
    
-   [SMTPS component](../../../components/4.22.x/mail-component.md), URI syntax: `smtps:host:port`
