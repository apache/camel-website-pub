...
-   [Ignite Cache component](../../../components/4.22.x/ignite-cache-component.md), URI syntax: `ignite-cache:cacheName`
    
-   [Ignite Compute component](../../../components/4.22.x/ignite-compute-component.md), URI syntax: `ignite-compute:endpointId`
    
-   [Ignite Events component](../../../components/4.22.x/ignite-events-component.md), URI syntax: `ignite-events:endpointId`
    
-   [Ignite ID Generator component](../../../components/4.22.x/ignite-idgen-component.md), URI syntax: `ignite-idgen:name`
    
-   [Ignite Messaging component](../../../components/4.22.x/ignite-messaging-component.md), URI syntax: `ignite-messaging:topic`
    
-   [Ignite Queues component](../../../components/4.22.x/ignite-queue-component.md), URI syntax: `ignite-queue:name`
    
-   [Ignite Sets component](../../../components/4.22.x/ignite-set-component.md), URI syntax: `ignite-set:name`
...
The starter supports 37 options, which are listed below.
