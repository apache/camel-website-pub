...
-   [Protobuf Jackson data format](../../../components/4.22.x/dataformats/protobufJackson3-dataformat.md)
...
<dependency>
    ...
    <artifactId>camel-jackson3-protobuf-starter</artifactId>
</dependency>
```
...
| camel.dataformat.protobuf-jackson.module-class-names | To use custom Jackson modules tools.jackson.databind.JacksonModule specified as a String with FQN class names. Multiple classes can be separated by comma. |  | String |
