...
-   [AWS Simple Notification System (SNS) component](../../../components/4.22.x/aws2-sns-component.md), URI syntax: `aws2-sns:topicNameOrArn`
...
| camel.component.aws2-sns.region | The region in which the SNS client needs to work. When using this parameter, the configuration will expect the lowercase name of the region (for example, ap-east-1) You’ll need to use the name Region.EU\_WEST\_1.id() |  | String |
