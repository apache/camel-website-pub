...
-   [Crypto (JCE) component](../../../components/4.22.x/crypto-component.md), URI syntax: `crypto:cryptoOperation:name`
    
-   [Crypto (Java Cryptographic Extension) data format](../../../components/4.22.x/dataformats/crypto-dataformat.md)
...
| camel.dataformat.crypto.algorithm-parameter-spec | A JCE AlgorithmParameterSpec used to initialize the Cipher. The option is a java.security.spec.AlgorithmParameterSpec type. |  | String |
