...
| camel.component.reactive-streams.backpressure-strategy | The backpressure strategy to use when pushing events to a slow subscriber. | buffer | ReactiveStreamsBackpressureStrategy |
