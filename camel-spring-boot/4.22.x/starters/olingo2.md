...
-   [Olingo2 component](../../../components/4.22.x/olingo2-component.md), URI syntax: `olingo2:apiName/methodName`
...
| camel.component.olingo2.http-headers | Custom HTTP headers to inject into every request, this could include OAuth tokens, etc. |  | String> |
...
| camel.component.olingo2.service-uri | Target OData service base URI, e.g. [http://services.odata.org/OData/OData.svc](http://services.odata.org/OData/OData.svc) |  | String |
