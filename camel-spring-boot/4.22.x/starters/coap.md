...
-   [CoAP component](../../../components/4.22.x/coap-component.md), URI syntax: `coap:uri`
    
-   [CoAP component](../../../components/4.22.x/coap-component.md), URI syntax: `coap+tcp:uri`
    
-   [CoAP component](../../../components/4.22.x/coap-component.md), URI syntax: `coaps+tcp:uri`
    
-   [CoAP (Secure) component](../../../components/4.22.x/coap-component.md), URI syntax: `coaps:uri`
...
| camel.component.coap.client | To use a shared client for the producers. The option is a org.eclipse.californium.core.CoapClient type. |  | CoapClient |
| camel.component.coap.configuration-file | Name of COAP configuration file to load and use. Will by default load from classpath, so use file: as prefix to load from file system. |  | String |
...
| camel.component.coap.header-filter-strategy | To use a custom org.apache.camel.spi.HeaderFilterStrategy to filter header to and from Camel message. The option is a org.apache.camel.spi.HeaderFilterStrategy type. |  | HeaderFilterStrategy |
