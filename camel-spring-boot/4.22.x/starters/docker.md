...
-   [Docker component](../../../components/4.22.x/docker-component.md), URI syntax: `docker:operation`
...
| camel.component.docker.server-address | Server address for docker registry. | [https://index.docker.io/v1/](https://index.docker.io/v1/) | String |
