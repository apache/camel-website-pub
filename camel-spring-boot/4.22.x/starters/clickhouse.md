...
-   [ClickHouse component](../../../components/4.22.x/clickhouse-component.md), URI syntax: `clickhouse:database`
...
| camel.component.clickhouse.server-url | The ClickHouse HTTP endpoint URL, e.g. [http://localhost:8123](http://localhost:8123). Can be overridden per endpoint. Required unless a shared Client bean is autowired or configured on the component. |  | String |
