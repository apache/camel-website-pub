...
-   [Minio component](../../../components/4.22.x/minio-component.md), URI syntax: `minio:bucketName`
...
| camel.component.minio.server-side-encryption-customer-key | Server-side encryption for source object while copy/move objects. The option is a io.minio.ServerSideEncryption.CustomerKey type. |  | ServerSideEncryption$CustomerKey |
