...
-   [SpEL language](../../../components/4.22.x/languages/spel-language.md)
    
-   [Spring Event component](../../../components/4.22.x/spring-event-component.md), URI syntax: `spring-event:name`
