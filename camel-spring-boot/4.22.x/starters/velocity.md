...
-   [Velocity component](../../../components/4.22.x/velocity-component.md), URI syntax: `velocity:resourceUri`
...
| camel.component.velocity.content-cache | Sets whether to use resource content cache or not | true | Boolean |
