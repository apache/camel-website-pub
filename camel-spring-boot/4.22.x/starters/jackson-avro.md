...
-   [Avro Jackson data format](../../../components/4.22.x/dataformats/avroJackson2-dataformat.md)
...
| camel.dataformat.avro-jackson.allow-unmarshall-type | If enabled then Jackson is allowed to attempt to use the CamelJacksonUnmarshalType header during the unmarshalling. | false | Boolean |
...
| camel.dataformat.avro-jackson.collection-type | Refers to a custom collection type to lookup in the registry to use. |  | String |
...
| camel.dataformat.avro-jackson.disable-features | Set of features to disable on the Jackson com.fasterxml.jackson.databind.ObjectMapper. Multiple features can be separated by comma. |  | String |
| camel.dataformat.avro-jackson.enable-features | Set of features to enable on the Jackson com.fasterxml.jackson.databind.ObjectMapper. Multiple features can be separated by comma. |  | String |
...
| camel.dataformat.avro-jackson.include | If you want to marshal a pojo to JSON, and the pojo has some fields with null values. And you want to skip these null values, you can set this option to NON\_NULL. |  | String |
