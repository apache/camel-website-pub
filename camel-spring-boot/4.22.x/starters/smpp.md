...
The starter supports 44 options, which are listed below.
...
| camel.component.smpp.proxy-headers | These headers will be passed to the proxy server while establishing the connection. |  | String> |
