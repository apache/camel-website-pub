...
The Spring Boot auto-configuration options are documented in the [Core starter](starters/core.md) page.
...
You can also use [camel-test-spring-junit6](../../components/4.22.x/others/test-spring-junit6.md) to configure tests declaratively. This example uses the `@MockEndpoints` annotation to auto-mock an endpoint:
