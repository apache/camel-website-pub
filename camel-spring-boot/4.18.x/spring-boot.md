...
| **camel.main.use-mdc-logging** | To turn on MDC logging. | false | Boolean |
...
| **management.endpoint.camel.enabled** | **Deprecated** Whether to enable the camel endpoint. | true | Boolean |
| **management.endpoint.camelroutecontroller.enabled** | **Deprecated** Whether to enable the camelroutecontroller endpoint. | true | Boolean |
| **management.endpoint.camelroutes.enabled** | **Deprecated** Whether to enable the camelroutes endpoint. | true | Boolean |
