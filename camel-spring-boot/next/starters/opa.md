...
-   [OPA component](../../../components/next/opa-component.md), URI syntax: `opa:policyPath`
...
| camel.component.opa.server-url | The base URL of the OPA server, without the \\{code /v1/data} suffix. The default assumes OPA running as a sidecar on the standard port. | [http://localhost:8181](http://localhost:8181) | String |