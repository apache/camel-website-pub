...
-   [Mina component](../../../components/next/mina-component.md), URI syntax: `mina:protocol:host:port`
...
| camel.component.mina.filters | You can set a list of Mina IoFilters to use. |  | IoFilter> |
...
| camel.component.mina.mute-exception | If enabled and an Exchange failed processing on the consumer side the response written back to the remote peer won’t contain the exception’s class, message or stack trace. | true | Boolean |
