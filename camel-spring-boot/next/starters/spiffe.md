...
-   [SPIFFE component](../../../components/next/spiffe-component.md), URI syntax: `spiffe:label`
...
| camel.component.spiffe.spiffe-socket-path | The address of the SPIFFE Workload API endpoint (for example \\{code unix:///tmp/agent.sock} or \\{code tcp://127.0.0.1:8082}). When not set, the SPIFFE\_ENDPOINT\_SOCKET environment variable is used. |  | String |
