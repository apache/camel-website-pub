...
-   [Micrometer component](../../../components/next/micrometer-component.md), URI syntax: `micrometer:metricsType:metricsName`
...
| camel.metrics.log-metrics-on-shutdown-format | Format used to log metrics when application is shutting down. Either json (default) or prometheus format. |  | String |
