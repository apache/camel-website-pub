...
| camel.component.jolt.content-cache | Sets whether to use resource content cache or not | true | Boolean |
...
| camel.component.jolt.transform | Explicitly sets the Transform to use. If not set a Transform specified by the transformDsl will be created. The option is a io.joltcommunity.jolt.Transform type. |  | Transform |