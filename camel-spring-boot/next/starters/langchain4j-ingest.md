...
-   [LangChain4j Ingest component](../../../components/next/langchain4j-ingest-component.md), URI syntax: `langchain4j-ingest:pipelineName`
...
| camel.component.langchain4j-ingest.min-document-size | Minimum size of one document in characters; 0, the default, means no minimum. A shorter document - boilerplate too small to carry retrievable content - is answered with a filtered result instead of being written, and releases its dedup claim like a blank one. | 0 | Integer |