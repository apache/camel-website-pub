...
This starter integrates Camel’s Saga EIP with a [MicroProfile LRA](https://download.eclipse.org/microprofile/microprofile-lra-1.0/microprofile-lra-spec-1.0.md) coordinator, enabling distributed saga transactions across Camel routes.
