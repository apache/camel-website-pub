...
-   [TypeSafe AI component](../../../components/next/typesafe-ai-component.md), URI syntax: `typesafe-ai:name`
    
-   [TypeSafe AI language](../../../components/next/languages/typesafe-ai-language.md)
...
| camel.component.typesafe-ai.base-url | The API base URL. The client appends /v1/systemone. Redirects are not followed. | [https://api.typesafe.ai](https://api.typesafe.ai) | String |
