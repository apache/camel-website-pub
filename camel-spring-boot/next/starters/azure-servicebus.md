...
| camel.component.azure-servicebus.max-concurrent-sessions | Sets the maximum number of concurrent sessions to process at any given time. Only applies when sessionEnabled is true. | 1 | Integer |
