...
| --- | --- |
| [apache-camel-3.20.8-src.zip](https://archive.apache.org/dist/camel/apache-camel/3.20.8/apache-camel-3.20.8-src.zip) (Sources) | [PGP Signature](https://archive.apache.org/dist/camel/apache-camel/3.20.8/apache-camel-3.20.8-src.zip.asc), [SHA512 Checksum](https://archive.apache.org/dist/camel/apache-camel/3.20.8/apache-camel-3.20.8-src.zip.sha512) |

## Git tag checkout

Release is tagged with `camel-3.20.8` in the Git, to fetch it use:

git clone https://git-wip-us.apache.org/repos/asf/camel.git
cd camel
git checkout camel-3.20.8
