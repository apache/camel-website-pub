# Apache camel-quarkus 2.2.0 Release
...
| --- | --- |
| [apache-camel-quarkus-2.2.0-src.zip](https://archive.apache.org/dist/camel/camel-quarkus/2.2.0/apache-camel-quarkus-2.2.0-src.zip) (Sources) | [PGP Signature](https://archive.apache.org/dist/camel/camel-quarkus/2.2.0/apache-camel-quarkus-2.2.0-src.zip.asc), [SHA512 Checksum](https://archive.apache.org/dist/camel/camel-quarkus/2.2.0/apache-camel-quarkus-2.2.0-src.zip.sha512) |

## Git tag checkout

Release is tagged with `2.2.0` in the Git, to fetch it use:
...
[#3025](https://github.com/apache/camel-quarkus/issues/3025)

kamelet: Test the kamelet location option

[#3023](https://github.com/apache/camel-quarkus/issues/3023)
...
[#2983](https://github.com/apache/camel-quarkus/issues/2983)

\[Quarkus 2.2.0\] XChange native itest fails to find \`CurrencyNames\` resource bundle

[#2981](https://github.com/apache/camel-quarkus/issues/2981)

Upgrade to to GraalVM 21.2

[#2980](https://github.com/apache/camel-quarkus/issues/2980)

\[Quarkus 2.2.0\] Spring RabbitMQ native build fails

[#2979](https://github.com/apache/camel-quarkus/issues/2979)

\[Quarkus 2.2.0\] \`quarkus-google-cloud-services\` dependent extensions native image build fails

[#2977](https://github.com/apache/camel-quarkus/issues/2977)

\[Quarkus 2.2.0\] XmlSecurity itests fail in native mode

[#2975](https://github.com/apache/camel-quarkus/issues/2975)

\[Quarkus 2.2.0\] Infinispan itests fail in native mode

[#2970](https://github.com/apache/camel-quarkus/issues/2970)

Skip querying Jandex for quarkus.camel.native.reflection.include-patterns that have no wildcards

[#2968](https://github.com/apache/camel-quarkus/issues/2968)

\[Quarkus 2.2.0\] JavaScriptDslTest fails with CNFE \`org.graalvm.polyglot.impl.AbstractPolyglotImpl$AbstractValueImpl\`
...
Provide a common set of JMS tests to test different combinations of JMS extension, client & broker
