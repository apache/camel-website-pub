...
| --- | --- |
| [apache-camel-4.0.4-src.zip](https://archive.apache.org/dist/camel/apache-camel/4.0.4/apache-camel-4.0.4-src.zip) (Sources) | [PGP Signature](https://archive.apache.org/dist/camel/apache-camel/4.0.4/apache-camel-4.0.4-src.zip.asc), [SHA512 Checksum](https://archive.apache.org/dist/camel/apache-camel/4.0.4/apache-camel-4.0.4-src.zip.sha512) |
| [apache-camel-4.0.4-sbom.xml](https://archive.apache.org/dist/camel/apache-camel/4.0.4/apache-camel-4.0.4-sbom.xml) (SBOM, CycloneDX XML) | [PGP Signature](https://archive.apache.org/dist/camel/apache-camel/4.0.4/apache-camel-4.0.4-sbom.xml.asc), [SHA512 Checksum](https://archive.apache.org/dist/camel/apache-camel/4.0.4/apache-camel-4.0.4-sbom.xml.sha512) |
| [apache-camel-4.0.4-sbom.json](https://archive.apache.org/dist/camel/apache-camel/4.0.4/apache-camel-4.0.4-sbom.json) (SBOM, CycloneDX JSON) | [PGP Signature](https://archive.apache.org/dist/camel/apache-camel/4.0.4/apache-camel-4.0.4-sbom.json.asc), [SHA512 Checksum](https://archive.apache.org/dist/camel/apache-camel/4.0.4/apache-camel-4.0.4-sbom.json.sha512) |

## Git tag checkout

Release is tagged with `camel-4.0.4` in the Git, to fetch it use:

git clone https://git-wip-us.apache.org/repos/asf/camel.git
cd camel
git checkout camel-4.0.4
