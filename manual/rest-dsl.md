...
-   [Binding and Configuration](rest-dsl-binding.md) — POJO binding, Jackson JSON features, CORS, OAuth Bearer token validation
    
-   [Error Handling and Validation](rest-dsl-validation.md) — Custom error messages, request/response validation, parameter defaults
    
-   [Contract First with OpenAPI](rest-dsl-openapi.md) — Using vanilla OpenAPI specification files with Rest DSL