...
The `camel-diagram` component provides a _route render_ functionality that can output visual diagrams of your Camel routes.

This feature can be used to automatically generate route diagrams as part of building and testing your projects.

For example as shown below:

![Foo Camel Route Diagram](_images/images/route-diagram-sample.png)
...
And if you run Camel JBang with `--console` then the developer console also comes with this functionality, by opening the link: [http://localhost:8080/q/dev/route-diagram](http://localhost:8080/q/dev/route-diagram)
...
-   **Topology Diagram**: Shows connections _between_ routes — how routes are wired together via shared endpoints like `direct`, `seda`, `kafka`, etc.
...
-   [Camel Main Standalone with route diagrams](https://github.com/apache/camel-examples/tree/main/main)
    
-   [Spring Boot with route diagrams](https://github.com/apache/camel-spring-boot-examples/tree/main/spring-boot)