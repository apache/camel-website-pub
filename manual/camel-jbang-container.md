...
Available image variants, supported architectures, and Java runtime versions may evolve over time. Before choosing an image, verify the available tags on [Apache Camel Jbang Docker Hub](https://hub.docker.com/r/apache/camel-jbang/tags).
