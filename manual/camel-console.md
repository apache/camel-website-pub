...
The Camel developer console is available in Spring Boot as an _actuator_. To enable the console you need to add dependency:
...
To make Camel able to discover custom dev consoles, then the [came-component-maven-plugin](camel-component-maven-plugin.md) must be used, such as:
