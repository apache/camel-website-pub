...
| `--theme,--colors` | Color theme preset (dark, light, transparent, text) or custom colors (e.g. bg=#1e1e1e:from=#2e7d32:to=#1565c0). Values can be #hex or ANSI color names (e.g. from=seagreen:to=steelblue). Use bg= for transparent. Can also be set via DIAGRAM\_COLORS env var. | dark | String |
