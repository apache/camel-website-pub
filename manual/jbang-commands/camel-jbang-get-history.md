...
| `--diagram` | Display a route diagram with the message path highlighted |  | boolean |
...
| `--theme` | Diagram color theme (ascii, unicode, dark, light, transparent, or custom) | unicode | String |
