...
`NotifyBuilder` has more than 30 methods. For full list of methods then see the [javadoc for NotifyBuilder](https://www.javadoc.io/doc/org.apache.camel/camel-core-model/current/org/apache/camel/builder/NotifyBuilder.md).
