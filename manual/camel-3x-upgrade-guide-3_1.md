...
#### Exchange.ROLLBACK\_ONLY and Exchange.ROLLBACK\_ONLY\_LAST
...
#### Exchange.ERRORHANDLER\_HANDLED
...
This change is motivated by the need to remove method ambiguity for untyped languages such as Groovy and JavaScript, for more info see [https://issues.apache.org/jira/browse/CAMEL-14300](https://issues.apache.org/jira/browse/CAMEL-14300)
