...
To instruct Camel to use your own custom class resolver, you set the resolver on the `CamelContext` using the appropriate setters; or register a custom resolver in the [Registry](registry.md) then Camel will automatically detect this during startup.
