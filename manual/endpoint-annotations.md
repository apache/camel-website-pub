...
You can annotate [Endpoint](endpoint.md) and [Component](component.md) classes, so that their configuration documentation can be automatically generated by Maven tooling via the [Camel Component Maven Plugin](camel-component-maven-plugin.md) into the `src/main/generated` folder.
