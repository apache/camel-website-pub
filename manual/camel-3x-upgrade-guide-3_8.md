...
-   GITHUB\_COMMIT\_AUTHOR - `CamelGitHubCommitAuthor` - The commit Author
    
-   GITHUB\_COMMIT\_COMMITTER - `CamelGitHubCommitCommitter` - The committer name
    
-   GITHUB\_COMMIT\_SHA - `CamelGitHubCommitSha` - The commit sha
    
-   GITHUB\_COMMIT\_URL - `CamelGitHubCommitUrl` - The commit url
...
-   GITHUB\_EVENT\_PAYLOAD - `CamelGitHubEventPayload` - The event payload
