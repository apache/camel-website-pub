...
-   [AWS2 DDB](../components/4.22.x/aws2-ddb-component.md)
    
-   [AWS2 Kinesis](../components/4.22.x/aws2-kinesis-component.md)
    
-   [AWS2 S3](../components/4.22.x/aws2-s3-component.md)
    
-   [AWS2 SQS](../components/4.22.x/aws2-sqs-component.md)
    
-   [File](../components/4.22.x/file-component.md)
...
-   [Minio](../components/4.22.x/minio-component.md)
...
Very often a `BatchConsumer` is scheduled and is based of the `ScheduledBatchPollingConsumer` that has many options for configuring the scheduling. These options are listed with _(scheduler)_ as label in the endpoint options' in the [Components](../components/4.22.x/index.md) documentation.
