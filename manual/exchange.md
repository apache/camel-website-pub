...
-   [Event Messages](../components/4.22.x/eips/event-message.md): messages that have only an inbound message
    
-   [Request and Reply](../components/4.22.x/eips/requestReply-eip.md): messages that have an inbound and an outbound message.
