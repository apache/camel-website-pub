...
| **camel.jbang.jib-maven-plugin-version** | Version to use for jib-maven-plugin when exporting the application | 3.5.2 | String |
| **camel.jbang.jkube-maven-plugin-version** | Version to use for jkube-maven-plugin if exporting to camel-main and have Kubernetes enabled (jkube.xxx options) | 1.20.0 | String |
...
> **Note**
> Placeholders only work for options that the given command supports. Run `camel <command> --help` to see available options.
