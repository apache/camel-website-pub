...
> **Important**
> If you are migrating from Camel 3.x then use the [Camel 3.x to 4.0 Migration Guide](camel-4-migration-guide.md) first.

This document is for helping you upgrade your Apache Camel application from Camel 4.x to 4.y. For example, if you are upgrading Camel 4.0 to 4.2, then you should follow the guides from both 4.0 to 4.1 and 4.1 to 4.2.

You can find the upgrade guide for each release in the following pages:

-   [Upgrade guide 4.0 → 4.1](camel-4x-upgrade-guide-4_1.md)
    
-   [Upgrade guide 4.1 → 4.2](camel-4x-upgrade-guide-4_2.md)
...
-   [Upgrade guide 4.5 → 4.6](camel-4x-upgrade-guide-4_6.md)
...
-   [Upgrade guide 4.11 → 4.12](camel-4x-upgrade-guide-4_12.md)
...
-   [Upgrade guide 4.15 → 4.16](camel-4x-upgrade-guide-4_16.md)
