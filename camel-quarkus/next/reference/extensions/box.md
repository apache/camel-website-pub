...
-   [Box component](../../../../components/4.22.x/box-component.md), URI syntax: `box:apiName/methodName`
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-box)
