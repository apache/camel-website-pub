...
-   [Bindy CSV data format](../../../../components/4.22.x/dataformats/bindy-dataformat.md)
    
-   [Bindy Fixed Length data format](../../../../components/4.22.x/dataformats/bindy-dataformat.md)
    
-   [Bindy Key Value Pair data format](../../../../components/4.22.x/dataformats/bindy-dataformat.md)
