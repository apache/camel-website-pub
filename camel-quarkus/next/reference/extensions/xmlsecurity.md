...
-   [XML Security data format](../../../../components/4.18.x/dataformats/xmlSecurity-dataformat.md)
    
-   [XML Security Sign component](../../../../components/4.18.x/xmlsecurity-sign-component.md), URI syntax: `xmlsecurity-sign:name`
    
-   [XML Security Verify component](../../../../components/4.18.x/xmlsecurity-verify-component.md), URI syntax: `xmlsecurity-verify:name`
