...
-   [AWS Security Token Service (STS) component](../../../../components/4.18.x/aws2-sts-component.md), URI syntax: `aws2-sts:label`
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-aws2-sts)
