...
The `quarkus-cxf-rt-ws-security` dependency has been removed from the `camel-quarkus-cxf-soap` extension. This aligns with the same change made in [Apache Camel 4.21.0](../../../manual/camel-4x-upgrade-guide-4_21.html#_ws_security_dependency_is_now_optional), where the WS-Security dependency was made optional.
