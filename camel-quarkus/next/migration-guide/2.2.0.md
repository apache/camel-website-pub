...
In previous releases, many of the `camel-grpc` consumer configuration options were ignored as the gRPC server configuration was driven by the `quarkus-grpc` extension.
