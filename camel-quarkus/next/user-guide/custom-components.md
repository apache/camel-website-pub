...
Camel Quarkus requires a [Jandex](https://github.com/smallrye/jandex) index to discover components at build time and perform build-time optimizations. Without this index, you may encounter `FailedToCreateRouteException` because the custom endpoint cannot be found.
...
See also [Registering classes for reflection](native-mode.html#reflection) for more details.
...
See also [Embedding resources in the native executable](native-mode.html#embedding-resource-in-native-executable) for more details.
