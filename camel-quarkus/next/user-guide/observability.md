...
For a simplified observability experience, use the [Observability Services](../reference/extensions/observability-services.md) extension. It provides all the above-mentioned features, together with some opinionated configuration defaults.