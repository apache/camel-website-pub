...
-   [Twilio component](../../../../components/4.18.x/twilio-component.md), URI syntax: `twilio:apiName/methodName`
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-twilio)
