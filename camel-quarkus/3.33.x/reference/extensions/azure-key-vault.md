...
-   [Azure Key Vault component](../../../../components/4.18.x/azure-key-vault-component.md), URI syntax: `azure-key-vault:vaultName`
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-azure-key-vault)
