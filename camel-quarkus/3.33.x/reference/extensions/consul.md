...
-   [Consul component](../../../../components/4.18.x/consul-component.md), URI syntax: `consul:apiEndpoint`
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-consul)
