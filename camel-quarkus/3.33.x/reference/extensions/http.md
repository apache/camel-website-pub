...
-   [HTTP component](../../../../components/4.18.x/http-component.md), URI syntax: `[http://httpUri](http://httpUri)`
    
-   [HTTPS (Secure) component](../../../../components/4.18.x/http-component.md), URI syntax: `[https://httpUri](https://httpUri)`
