...
-   [CouchDB component](../../../../components/4.18.x/couchdb-component.md), URI syntax: `couchdb:protocol:hostname:port/database`
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-couchdb)
