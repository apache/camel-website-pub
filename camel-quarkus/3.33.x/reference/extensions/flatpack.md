...
-   [Flatpack component](../../../../components/4.18.x/flatpack-component.md), URI syntax: `flatpack:type:resourceUri`
    
-   [Flatpack data format](../../../../components/4.18.x/dataformats/flatpack-dataformat.md)
