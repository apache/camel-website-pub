...
-   [Bean component](../../../../components/4.18.x/bean-component.md), URI syntax: `bean:beanName`
    
-   [Bean Method language](../../../../components/4.18.x/languages/bean-language.md)
    
-   [Class component](../../../../components/4.18.x/class-component.md), URI syntax: `class:beanName`
