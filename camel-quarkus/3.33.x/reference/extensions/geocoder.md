...
-   [Geocoder component](../../../../components/4.18.x/geocoder-component.md), URI syntax: `geocoder:address:latlng`
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-geocoder)
