...
-   [AWS Identity and Access Management (IAM) component](../../../../components/4.18.x/aws2-iam-component.md), URI syntax: `aws2-iam:label`
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-aws2-iam)
