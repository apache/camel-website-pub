...
-   [MyBatis component](../../../../components/4.18.x/mybatis-component.md), URI syntax: `mybatis:statement`
    
-   [MyBatis Bean component](../../../../components/4.18.x/mybatis-bean-component.md), URI syntax: `mybatis-bean:beanName:methodName`
