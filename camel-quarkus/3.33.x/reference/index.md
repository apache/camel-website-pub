...
There are 338 extensions (10 deprecated, 68 JVM only)
...
| [ArangoDb](extensions/arangodb.md) | camel-quarkus-arangodb | 1.1.0 | 1.1.0 | Stable | Perform operations on ArangoDb documents, collections and graphs. |
...
| [Asterisk](extensions/asterisk.md) | camel-quarkus-asterisk | 1.1.0 | n/a | Preview | Interact with Asterisk PBX Server. |
...
| [AWS 2 Athena](extensions/aws2-athena.md) | camel-quarkus-aws2-athena | 1.0.0 | 1.0.0 | Stable | Access AWS Athena service using AWS SDK version 2.x. |
| [AWS 2 CloudWatch](extensions/aws2-cw.md) | camel-quarkus-aws2-cw | 1.0.0 | 1.0.0 | Stable | Sending metrics to AWS CloudWatch. |
| [AWS 2 DynamoDB](extensions/aws2-ddb.md) | camel-quarkus-aws2-ddb | 1.0.0 | 1.0.0 | Stable | Store and retrieve data from AWS DynamoDB service or receive messages from AWS DynamoDB Stream using AWS SDK version 2.x. |
...
| [AWS 2 Eventbridge](extensions/aws2-eventbridge.md) | camel-quarkus-aws2-eventbridge | 1.4.0 | 1.7.0 | Stable | Manage AWS Eventbridge cluster instances using AWS SDK version 2.x. |
...
| [AWS 2 Kinesis](extensions/aws2-kinesis.md) | camel-quarkus-aws2-kinesis | 1.1.0 | 1.7.0 | Stable | Consume and produce records from AWS Kinesis Streams using AWS SDK version 2.x. |
| [AWS 2 Lambda](extensions/aws2-lambda.md) | camel-quarkus-aws2-lambda | 1.1.0 | 1.1.0 | Stable | Manage and invoke AWS Lambda functions using AWS SDK version 2.x. |
...
| [AWS 2 Security Token Service (STS)](extensions/aws2-sts.md) | camel-quarkus-aws2-sts | 1.1.0 | 1.1.0 | Stable | Manage AWS STS cluster instances using AWS SDK version 2.x. |
...
| [AWS Secrets Manager](extensions/aws-secrets-manager.md) | camel-quarkus-aws-secrets-manager | 2.0.0 | 3.19.0 | Stable | Manage AWS Secrets Manager services using AWS SDK version 2.x. |
| [AWS XRay](extensions/aws-xray.md) | camel-quarkus-aws-xray | 1.2.0 | n/a | Preview Deprecated | Distributed tracing using AWS XRay |
| [Azure CosmosDB](extensions/azure-cosmosdb.md) | camel-quarkus-azure-cosmosdb | 2.0.0 | n/a | Preview | Azure Cosmos DB is Microsofts globally distributed, multi-model database service for operational and analytics workloads. It offers multi-mastering feature by automatically scaling throughput, compute, and storage. This component interacts with Azure CosmosDB through Azure SQL API |
| [Azure Event Hubs](extensions/azure-eventhubs.md) | camel-quarkus-azure-eventhubs | 1.7.0 | 1.7.0 | Stable | The azure-eventhubs component that integrates Azure Event Hubs using AMQP protocol. Azure EventHubs is a highly scalable publish-subscribe service that can ingest millions of events per second and stream them to multiple consumers. |
...
| [Azure Storage Blob Service](extensions/azure-storage-blob.md) | camel-quarkus-azure-storage-blob | 1.1.0 | 1.6.0 | Stable | Store and retrieve blobs from Azure Storage Blob Service using SDK v12. |
| [Azure storage datalake service](extensions/azure-storage-datalake.md) | camel-quarkus-azure-storage-datalake | 1.8.0 | 3.24.0 | Stable | Camel Azure Datalake Gen2 Component |
| [Azure Storage Queue Service](extensions/azure-storage-queue.md) | camel-quarkus-azure-storage-queue | 1.1.0 | 1.7.0 | Stable | The azure-storage-queue component is used for storing and retrieving the messages to/from Azure Storage Queue using Azure SDK v12. |
...
| [Cloud](extensions/core-cloud.md) | camel-quarkus-core-cloud | 0.2.0 | 0.2.0 | Stable | The Camel Quarkus core cloud module |
...
| [CoAP](extensions/coap.md) | camel-quarkus-coap | 1.1.0 | n/a | Preview | Send and receive messages to/from COAP capable devices. |
...
| [CSimple](extensions/csimple.md) | camel-quarkus-csimple | 1.5.0 | 1.5.0 | Preview | Compiled Simple language |
...
| [DSL Modeline](extensions/dsl-modeline.md) | camel-quarkus-dsl-modeline | 2.14.0 | n/a | Preview | Support for Camel K style modeline |
...
| [FHIR](extensions/fhir.md) | camel-quarkus-fhir | 0.3.0 | 0.3.0 | Stable | Exchange information in the healthcare domain using the FHIR (Fast Healthcare Interoperability Resources) standard. Marshall and unmarshall FHIR objects to/from JSON. Marshall and unmarshall FHIR objects to/from XML. |
...
| [GitHub](extensions/github.md) | camel-quarkus-github | 1.0.0 | 1.0.0 | Stable Deprecated | Interact with the GitHub API. |
...
| [Google Calendar](extensions/google-calendar.md) | camel-quarkus-google-calendar | 1.0.0 | 1.0.0 | Stable | Perform various operations on a Google Calendar. Poll for changes in a Google Calendar. |
| [Google Drive](extensions/google-drive.md) | camel-quarkus-google-drive | 1.0.0 | 1.0.0 | Stable | Manage files in Google Drive. |
| [Google Mail](extensions/google-mail.md) | camel-quarkus-google-mail | 1.0.0 | 1.0.0 | Stable | Manage messages in Google Mail. Poll for incoming messages in Google Mail. |
...
| [Google Sheets](extensions/google-sheets.md) | camel-quarkus-google-sheets | 1.0.0 | 1.0.0 | Stable | Manage spreadsheets in Google Sheets. Poll for changes in Google Sheets. |
...
| [Guava EventBus](extensions/guava-eventbus.md) | camel-quarkus-guava-eventbus | 1.1.0 | n/a | Preview Deprecated | Send and receive messages to/from Guava EventBus. |
...
| [Java jOOR DSL](extensions/java-joor-dsl.md) | camel-quarkus-java-joor-dsl | 1.8.0 | 2.16.0 | Stable | Support for parsing Java route definitions at runtime |
...
| [JSLT](extensions/jslt.md) | camel-quarkus-jslt | 1.1.0 | 1.4.0 | Stable | Query or transform JSON payloads using an JSLT. |
...
| [JSON Path](extensions/jsonpath.md) | camel-quarkus-jsonpath | 1.0.0 | 1.0.0 | Stable | Evaluate a JSONPath expression against a JSON message body |
...
| [JSONATA](extensions/jsonata.md) | camel-quarkus-jsonata | 1.6.0 | 1.6.0 | Stable | JSON to JSON transformation using JSONATA. |
| [JsonPatch](extensions/json-patch.md) | camel-quarkus-json-patch | 2.7.0 | n/a | Preview Deprecated | JsonPatch component which transform JSON using JSON patch (RFC 6902). |
...
| [JTA](extensions/jta.md) | camel-quarkus-jta | 1.0.0 | 1.0.0 | Stable | Enclose Camel routes in transactions using Java Transaction API (JTA) and Narayana transaction manager |
...
| [Kamelet](extensions/kamelet.md) | camel-quarkus-kamelet | 1.7.0 | 1.7.0 | Stable | Materialize route templates |
...
| [LangChain4j Tools](extensions/langchain4j-tools.md) | camel-quarkus-langchain4j-tools | 3.15.0 | 3.24.0 | Preview | LangChain4j Tools and Function Calling Features |
...
| [Log](extensions/log.md) | camel-quarkus-log | 0.0.1 | 0.0.1 | Stable | Prints data form the routed message (such as body and headers) to the logger. |
...
| [Mail](extensions/mail.md) | camel-quarkus-mail | 0.2.0 | 0.2.0 | Stable | Send and receive emails using imap, pop3 and smtp protocols. Marshal Camel messages with attachments into MIME-Multipart messages and back. |
...
| [Management](extensions/management.md) | camel-quarkus-management | 1.1.0 | 3.2.0 | Stable | JMX management strategy and associated managed resources. |
...
| [Nitrite](extensions/nitrite.md) | camel-quarkus-nitrite | 1.0.0 | 1.8.0 | Stable Deprecated | Access Nitrite databases. |
...
| [OGNL](extensions/ognl.md) | camel-quarkus-ognl | 1.0.0 | 3.2.0 | Stable Deprecated | Evaluate an OGNL expression using Apache Commons OGNL |
...
| [Once](extensions/once.md) | camel-quarkus-once | 3.31.0 | 3.31.0 | Stable | Camel Once component |
...
| [OpenAI](extensions/openai.md) | camel-quarkus-openai | 3.32.0 | 3.32.0 | Stable | OpenAI endpoint for chat completion. |
| [OpenAPI Java](extensions/openapi-java.md) | camel-quarkus-openapi-java | 1.0.0 | 1.0.0 | Stable | Expose OpenAPI resources defined in Camel REST DSL |
...
| [PGP](extensions/crypto-pgp.md) | camel-quarkus-crypto-pgp | 3.13.0 | 3.13.0 | Stable | Encrypt and decrypt messages using Bouncy Castle OpenPGP API. |
...
| [PQC Algorithms](extensions/pqc.md) | camel-quarkus-pqc | 3.24.0 | n/a | Preview | Post Quantum Computing Signature and Verification component. |
...
| [Reactive Executor](extensions/reactive-executor.md) | camel-quarkus-reactive-executor | 0.3.0 | 0.3.0 | Stable | Reactive Executor for camel-core using Vert.x |
...
| [Robot Framework](extensions/robotframework.md) | camel-quarkus-robotframework | 1.1.0 | n/a | Preview | Pass camel exchanges to acceptence test written in Robot DSL. |
...
| [SimpleNotification](extensions/huaweicloud-smn.md) | camel-quarkus-huaweicloud-smn | 1.8.0 | n/a | Preview | Huawei Cloud component to integrate with SimpleNotification services |
...
| [SMB](extensions/smb.md) | camel-quarkus-smb | 3.7.0 | 3.7.0 | Stable | SMB component which consumes natively from file shares using the Server Message Block (SMB, also known as Common Internet File System - CIFS) protocol |
...
| [Splunk HEC](extensions/splunk-hec.md) | camel-quarkus-splunk-hec | 1.1.0 | 3.8.0 | Stable | The splunk component allows to publish events in Splunk using the HTTP Event Collector. |
| [Spring RabbitMQ](extensions/spring-rabbitmq.md) | camel-quarkus-spring-rabbitmq | 1.7.0 | 1.7.0 | Stable | Send and receive messages from RabbitMQ using Spring RabbitMQ client. |
...
| [Stomp](extensions/stomp.md) | camel-quarkus-stomp | 1.1.0 | n/a | Preview Deprecated | Send and rececive messages to/from STOMP (Simple Text Oriented Messaging Protocol) compliant message brokers. |
...
| [ThreadPoolFactory Vert.x](extensions/threadpoolfactory-vertx.md) | camel-quarkus-threadpoolfactory-vertx | 1.0.0 | 1.0.0 | Stable | ThreadPoolFactory for camel-core using Vert.x |
...
| [Vert.x HTTP Client](extensions/vertx-http.md) | camel-quarkus-vertx-http | 1.1.0 | 1.1.0 | Stable | Camel HTTP client support with Vert.x |
| [Vert.x WebSocket](extensions/vertx-websocket.md) | camel-quarkus-vertx-websocket | 1.1.0 | 1.1.0 | Stable | Camel WebSocket support with Vert.x |
...
| [Wordpress](extensions/wordpress.md) | camel-quarkus-wordpress | 1.1.0 | n/a | Preview | Manage posts and users using Wordpress API. |
...
| [XML IO DSL](extensions/xml-io-dsl.md) | camel-quarkus-xml-io-dsl | 1.8.0 | 1.8.0 | Stable | An XML stack for parsing XML route definitions |
...
| [YAML DSL](extensions/yaml-dsl.md) | camel-quarkus-yaml-dsl | 1.8.0 | 1.8.0 | Stable | An YAML stack for parsing YAML route definitions |
| [YAML IO](extensions/yaml-io.md) | camel-quarkus-yaml-io | 3.2.0 | 3.2.0 | Stable | Dump routes in YAML format |
