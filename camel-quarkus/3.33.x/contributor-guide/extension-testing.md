...
The use cases explained in the given components documentation usually give a good guidance. For example, when writing tests for the SQL extension, you would go to documentation page of the [SQL component](../../../components/4.18.x/sql-component.md) and try to cover the use cases mentioned there: [Treatment of the message body](../../../components/4.18.x/sql-component.html#_treatment_of_the_message_body) [Result of the query](../../../components/4.18.x/sql-component.html#_result_of_the_query), [Using StreamList](../../../components/4.18.x/sql-component.html#_using_streamlist), etc.
