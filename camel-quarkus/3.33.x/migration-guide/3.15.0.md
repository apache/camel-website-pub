...
Quarkus now aligns with Micrometer 1.13.x. Refer to the [Quarkus migration guide](https://github.com/quarkusio/quarkus/wiki/Migration-Guide-3.14#micrometer) for more details.
...
Using JUnit Lifecycle.PER\_CLASS in conjunction with CamelQuarkusTestSupport is deprecated and will not be supported in future releases.