...
There are 31 misc. components (0 deprecated, 6 JVM only)
...
| [XML DSL](extensions/xml-io-dsl.md) | camel-quarkus-xml-io-dsl | 1.8.0 | 1.8.0 | Stable | Camel XML DSL with camel-xml-io |
| [YAML DSL](extensions/yaml-dsl.md) | camel-quarkus-yaml-dsl | 1.8.0 | 1.8.0 | Stable | Camel DSL with YAML |
| [Yaml Io](extensions/yaml-io.md) | camel-quarkus-yaml-io | 3.0.0 | 3.0.0 | Stable | Camel YAML IO |