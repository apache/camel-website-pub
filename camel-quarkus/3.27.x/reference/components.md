...
There are 296 components (2 deprecated, 63 JVM only)
...
| [LangChain4j Embeddings](extensions/langchain4j-embeddings.md) | camel-quarkus-langchain4j-embeddings | 3.10.0 | n/a | Preview | LangChain4j Embeddings |
...
| [Milvus](extensions/milvus.md) | camel-quarkus-milvus | 3.10.0 | n/a | Preview | Perform operations on the Milvus Vector Database. |
