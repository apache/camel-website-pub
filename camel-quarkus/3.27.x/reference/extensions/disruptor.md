...
-   [Disruptor component](../../../../components/4.14.x/disruptor-component.md), URI syntax: `disruptor:name`
    
-   [Disruptor VM component](../../../../components/4.14.x/disruptor-component.md), URI syntax: `disruptor-vm:name`
