...
JVM since3.10.0 Nativeunsupported

LangChain4j Embeddings

## What’s inside

-   [LangChain4j Embeddings component](../../../../components/4.14.x/langchain4j-embeddings-component.md), URI syntax: `langchain4j-embeddings:embeddingId`
