...
-   [MyBatis component](../../../../components/4.14.x/mybatis-component.md), URI syntax: `mybatis:statement`
    
-   [MyBatis Bean component](../../../../components/4.14.x/mybatis-bean-component.md), URI syntax: `mybatis-bean:beanName:methodName`
