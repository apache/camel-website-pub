...
-   [Google BigQuery component](../../../../components/4.14.x/google-bigquery-component.md), URI syntax: `google-bigquery:projectId:datasetId:tableId`
    
-   [Google BigQuery Standard SQL component](../../../../components/4.14.x/google-bigquery-sql-component.md), URI syntax: `google-bigquery-sql:projectId:queryString`
