...
-   [InfluxDB component](../../../../components/4.14.x/influxdb-component.md), URI syntax: `influxdb:connectionBean`
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-influxdb)
