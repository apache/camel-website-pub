...
-   [SQL component](../../../../components/4.14.x/sql-component.md), URI syntax: `sql:query`
    
-   [SQL Stored Procedure component](../../../../components/4.14.x/sql-stored-component.md), URI syntax: `sql-stored:template`
