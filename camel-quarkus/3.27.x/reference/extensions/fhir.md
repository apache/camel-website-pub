...
-   [FHIR component](../../../../components/4.14.x/fhir-component.md), URI syntax: `fhir:apiName/methodName`
    
-   [FHIR JSon data format](../../../../components/4.14.x/dataformats/fhirJson-dataformat.md)
    
-   [FHIR XML data format](../../../../components/4.14.x/dataformats/fhirXml-dataformat.md)
