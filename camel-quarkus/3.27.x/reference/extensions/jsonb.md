...
-   [JSON JSON-B data format](../../../../components/4.14.x/dataformats/jsonb-dataformat.md)
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-jsonb)
