...
-   [Constant language](../../../../components/4.14.x/languages/constant-language.md)
    
-   [ExchangeProperty language](../../../../components/4.14.x/languages/exchangeProperty-language.md)
    
-   [File language](../../../../components/4.14.x/languages/file-language.md)
    
-   [Header language](../../../../components/4.14.x/languages/header-language.md)
    
-   [Ref language](../../../../components/4.14.x/languages/ref-language.md)
    
-   [Simple language](../../../../components/4.14.x/languages/simple-language.md)
    
-   [Tokenize language](../../../../components/4.14.x/languages/tokenize-language.md)
    
-   [Variable language](../../../../components/4.14.x/languages/variable-language.md)
