...
-   [Quartz component](../../../../components/4.14.x/quartz-component.md), URI syntax: `quartz:groupName/triggerName`
...
Further customization of the Quartz scheduler can be done via various configuration properties. Refer to to the [Quarkus Quartz Configuration](https://quarkus.io/guides/quartz#quartz-configuration-reference) guide for more information.