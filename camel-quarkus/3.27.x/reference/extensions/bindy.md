...
-   [Bindy CSV data format](../../../../components/4.14.x/dataformats/bindy-dataformat.md)
    
-   [Bindy Fixed Length data format](../../../../components/4.14.x/dataformats/bindy-dataformat.md)
    
-   [Bindy Key Value Pair data format](../../../../components/4.14.x/dataformats/bindy-dataformat.md)
