...
-   [Debezium MySQL Connector component](../../../../components/4.14.x/debezium-mysql-component.md), URI syntax: `debezium-mysql:name`
...
`quarkus-bom` (transitively included by `camel-quarkus-bom` and `quarkus-camel-bom`) manages a version of `com.mysql:mysql-connector-j` compatible with Camel Quarkus. So you do not need specify the version of the driver when importing any of the aforementioned BOMs. The following should be sufficient for Maven:
