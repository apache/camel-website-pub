...
-   [Opentelemetry2](../../../../components/4.14.x/others/opentelemetry2.md)
...
> **Note**
> this extension may eventually replace the `opentelemetry` extension. You’re invited to change the older extension usage with this one.
