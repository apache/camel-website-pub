...
-   [Splunk component](../../../../components/4.14.x/splunk-component.md), URI syntax: `splunk:name`
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-splunk)
