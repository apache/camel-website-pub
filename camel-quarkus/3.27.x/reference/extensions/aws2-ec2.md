...
-   [AWS Elastic Compute Cloud (EC2) component](../../../../components/4.14.x/aws2-ec2-component.md), URI syntax: `aws2-ec2:label`
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-aws2-ec2)
