...
-   [Kudu component](../../../../components/4.14.x/kudu-component.md), URI syntax: `kudu:host:port/tableName`
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-kudu)
