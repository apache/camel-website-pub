...
-   [Crypto (Java Cryptographic Extension) data format](../../../../components/4.14.x/dataformats/crypto-dataformat.md)
    
-   [Crypto (JCE) component](../../../../components/4.14.x/crypto-component.md), URI syntax: `crypto:cryptoOperation:name`
