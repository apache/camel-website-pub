...
-   [AWS Athena component](../../../../components/4.14.x/aws2-athena-component.md), URI syntax: `aws2-athena:label`
...
[Create a new project with this extension on code.quarkus.io](https://code.quarkus.io/?extension-search=camel-quarkus-aws2-athena)
