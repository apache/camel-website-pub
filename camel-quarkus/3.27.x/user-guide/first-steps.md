...
-   Apache Maven 3.8.2+ (3.9.11 is recommended)
...
Projects can be generated at [code.quarkus.io](https://code.quarkus.io). All of the Camel Quarkus extensions can be found under the 'Integration' category. Use the 'search' field to help with finding extensions that you are interested in.
...
```shell
mvn io.quarkus:quarkus-maven-plugin:3.27.4.1:create \
