...
`camel-quarkus-core` brings functionalities from [Camel Main](../../../components/4.14.x/others/main.md) to Camel Quarkus.
...
Component options for which this is supported are marked as _Autowired_ on their documentation pages - see e.g. the `exchangeFormatter` option on the [Log component](../../../components/4.14.x/log-component.html#_component_option_exchangeFormatter) page.
