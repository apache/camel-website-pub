...
| camel.idempotency.kafka.topic | The Kafka topic name to use for the idempotent repository | kafka\_idempotent\_repository | LOW |
...
For more options related to single connector you can have a look at [Connectors list](../reference/index.md).
