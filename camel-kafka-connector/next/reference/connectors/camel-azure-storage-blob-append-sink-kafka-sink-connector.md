...
The camel-azure-storage-blob-append-sink sink connector supports 7 options, which are listed below.
...
| **camel.kamelet.azure-storage-blob-append-sink.clientId** | The Azure Storage Blob client Id. |  | MEDIUM |
| **camel.kamelet.azure-storage-blob-append-sink.clientSecret** | The Azure Storage Blob client secret. |  | MEDIUM |
| **camel.kamelet.azure-storage-blob-append-sink.tenantId** | The Azure Storage Blob tenant id. |  | MEDIUM |
