...
The camel-azure-storage-blob-event-based-source source connector supports 12 options, which are listed below.
...
| **camel.kamelet.azure-storage-blob-event-based-source.accessKey** | The Azure Storage Blob access key. |  | MEDIUM |
| **camel.kamelet.azure-storage-blob-event-based-source.clientId** | The Azure Storage Blob client Id. |  | MEDIUM |
| **camel.kamelet.azure-storage-blob-event-based-source.clientSecret** | The Azure Storage Blob client secret. |  | MEDIUM |
| **camel.kamelet.azure-storage-blob-event-based-source.tenantId** | The Azure Storage Blob tenant id. |  | MEDIUM |
