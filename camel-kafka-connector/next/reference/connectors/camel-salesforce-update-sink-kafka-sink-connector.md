...
| --- | --- | --- | --- |
| **camel.kamelet.salesforce-update-sink.loginUrl** | The Salesforce instance login URL. | "https://login.salesforce.com" | MEDIUM |
| **camel.kamelet.salesforce-update-sink.clientId** | **Required** The Salesforce application consumer key. |  | HIGH |
| **camel.kamelet.salesforce-update-sink.clientSecret** | **Required** The Salesforce application consumer secret. |  | HIGH |
| **camel.kamelet.salesforce-update-sink.userName** | **Required** The Salesforce username. |  | HIGH |
| **camel.kamelet.salesforce-update-sink.password** | **Required** The Salesforce user password. |  | HIGH |
