...
In Apache Camel it exists the [Aggregate EIP](../../../components/next/eips/aggregate-eip.md) implementation and in Camel-Kafka-connector we wanted to leverage what we already have in the plain Apache Camel project.
...
Take a look at [Extending Connectors Documentation](extending-connector/index.md)