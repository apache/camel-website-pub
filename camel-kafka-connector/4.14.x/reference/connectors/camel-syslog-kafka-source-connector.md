...
The camel-syslog source connector supports is based on camel-netty source connector and supports all its options (see: [Netty Source Docs](camel-netty-kafka-source-connector.md)); however has been already preconfigured and should be sufficient to provide the following properties:
