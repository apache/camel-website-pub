...
-   If you created your account recently (within the last 1 month, please reach out to us on the [#camel-core-dev channel on ZulipChat](https://camel.zulipchat.com) to confirm your identity before making any contributions
    

> **Note**
> everyone that participates in an Apache Community must follow the [ASF Code of Conduct](https://www.apache.org/foundation/policies/conduct). Please make sure you read it before contributing.

### Small contributions

To maintain the quality and coherence of our project, we expect contributions to be **focused and small** in scope. This means that each contribution should:
...
> **Note**
> Larger contributions, regardless of being to existing code or new code, also require opening a ticket on [Jira](https://issues.apache.org/jira/projects/CAMEL/summary).

For larger contributions to **existing code** that **require significant changes** or have far-reaching implications, please discuss your plans with us in advance. You can do this by:
...
For larger contributions of **new code**, such as a new component or feature, that it is more isolated than the rest of the code, are easier to get accepted. In such circumstances, only the Jira ticket may suffice.

These measures are in place due to recent social-based attacks on open-source projects. By following these guidelines, we can:
...
-   Want to do some hacking on Camel? Try surfing on our [issue tracker](https://issues.apache.org/jira/browse/CAMEL) for open issues, feature requests, and planned tasks. Take ownership of a particular issue, and try to fix it.
