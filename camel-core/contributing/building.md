...
-   Java 11 (we test using [OpenJDK](https://adoptium.net/), but any modern JDK should be fine).
    
-   [Apache Maven](https://maven.apache.org) version 3.8.0 or greater to build the code. You can either use your own Maven package or build using the [Maven Wrapper](https://github.com/takari/maven-wrapper) (`mvnw`) provided with the project.
    

## Prerequisites for Camel 4.x

-   Java 21 (we test using [OpenJDK](https://adoptium.net/), but any modern JDK should be fine).
    
-   [Maven Wrapper](https://github.com/takari/maven-wrapper) can be used and is bundled.
    
-   [Apache Maven](https://maven.apache.org) version 3.9.0 or greater to build the code. You can either use your own Maven package or build using the [Maven Wrapper](https://github.com/takari/maven-wrapper) (`mvnw`) provided with the project.
