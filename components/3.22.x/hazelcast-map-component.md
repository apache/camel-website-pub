...
The [Hazelcast](http://www.hazelcast.com/) Map component is one of Camel Hazelcast Components which allows you to access Hazelcast distributed map.
...
The Hazelcast Map component supports 10 message header(s), which is/are listed below:
