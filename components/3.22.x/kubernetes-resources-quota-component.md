...
The Kubernetes Resources Quota component is one of [Kubernetes Components](kubernetes-summary.md) which provides a producer to execute Kubernetes Resource Quota operations.
...
The Kubernetes Resources Quota component supports 5 message header(s), which is/are listed below:
...
| **CamelKubernetesResourcesQuotaLabels** (producer) Constant: [`KUBERNETES_RESOURCES_QUOTA_LABELS`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_RESOURCES_QUOTA_LABELS) | The resource quota labels. |  | Map |
| **CamelKubernetesResourcesQuotaName** (producer) Constant: [`KUBERNETES_RESOURCES_QUOTA_NAME`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_RESOURCES_QUOTA_NAME) | The resource quota name. |  | String |
| **CamelKubernetesResourceQuotaSpec** (producer) Constant: [`KUBERNETES_RESOURCE_QUOTA_SPEC`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_RESOURCE_QUOTA_SPEC) | The spec for a resource quota. |  | ResourceQuotaSpec |
...
When using kubernetes-resources-quota with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
