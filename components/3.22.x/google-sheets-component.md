...
| **scopes** (common) | Sheets scopes. |  | Collection |
...
| --- | --- | --- |
| **range** | The A1 notation of a range to search for a logical table of data. Values are appended after the last row of the table. | String |
...
| **range** | The A1 notation or R1C1 notation of the values to clear. | String |
| **spreadsheetId** | The ID of the spreadsheet to update | String |
...
| Parameter | Description | Type |
| --- | --- | --- |
| **range** | The A1 notation or R1C1 notation of the range to retrieve values from. | String |
| **spreadsheetId** | The ID of the spreadsheet to retrieve data from | String |
...
| Parameter | Description | Type |
| --- | --- | --- |
| **range** | The A1 notation of the values to update. | String |
| **spreadsheetId** | The ID of the spreadsheet to update | String |
| **values** | The com.google.api.services.sheets.v4.model.ValueRange | ValueRange |
...
| **camel.component.google-sheets-stream.scopes** | Specifies the level of permissions you want a sheets application to have to a user account. See [https://developers.google.com/identity/protocols/googlescopes](https://developers.google.com/identity/protocols/googlescopes) for more info. |  | List |
...
| **camel.component.google-sheets.scopes** | Sheets scopes. |  | Collection |
