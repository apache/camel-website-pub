...
| **tags** (producer) | Tags of metrics. |  | Iterable |
...
In Camel 3.20 or older, then the naming of metrics are using _camelCase_ style. However, since Camel 3.21 onwards, the naming is using micrometer convention style (see table above).
