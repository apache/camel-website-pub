...
The [Vert.x](http://vertx.io/) HTTP component provides the capability to produce messages to HTTP endpoints via the [Vert.x Web Client](https://vertx.io/docs/vertx-web-client/java/).
