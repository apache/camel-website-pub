...
This component is currently using Java SDK 3.x so it might be not compatible with older Couchbase servers anymore. See the compatibility [page](https://docs.couchbase.com/java-sdk/current/project-docs/compatibility.md).
