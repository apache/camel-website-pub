...
> **Warning**
> **Deprecated:** This hbase is deprecated and may be removed in a future release.

**Since Camel 2.10**

**Both producer and consumer are supported**

This component provides an idempotent repository, producers and consumers for [Apache HBase](http://hbase.apache.org/).
...
HBase is an open-source, distributed, versioned, column-oriented store modeled after Google’s Bigtable: A Distributed Storage System for Structured Data. You can use HBase when you need random, realtime read/write access to your Big Data. More information at [Apache HBase](http://hbase.apache.org).
...
| Name | Description | Default | Type |
| --- | --- | --- | --- |
| **tableName** (common) | **Required** The name of the table. |  | String |
...
| Name | Description | Default | Type |
| --- | --- | --- | --- |
| **CamelHBaseOperation** (producer) Constant: [`OPERATION`](https://javadoc.io/doc/org.apache.camel/camel-hbase/latest/org/apache/camel/component/hbase/HBaseConstants.html#OPERATION) | The HBase operation to perform. |  | String |
| **CamelHBaseMaxScanResults** (producer) Constant: [`HBASE_MAX_SCAN_RESULTS`](https://javadoc.io/doc/org.apache.camel/camel-hbase/latest/org/apache/camel/component/hbase/HBaseConstants.html#HBASE_MAX_SCAN_RESULTS) | The maximum number of rows to scan. |  | Integer |
| **CamelHBaseStartRow** (producer) Constant: [`FROM_ROW`](https://javadoc.io/doc/org.apache.camel/camel-hbase/latest/org/apache/camel/component/hbase/HBaseConstants.html#FROM_ROW) | The row to start scanner at or after. |  | String |
| **CamelHBaseStopRow** (producer) Constant: [`STOP_ROW`](https://javadoc.io/doc/org.apache.camel/camel-hbase/latest/org/apache/camel/component/hbase/HBaseConstants.html#STOP_ROW) | The row to end at (exclusive). |  | String |
| **CamelMappingStrategy** (common) Constant: [`STRATEGY`](https://javadoc.io/doc/org.apache.camel/camel-hbase/latest/org/apache/camel/component/hbase/HBaseConstants.html#STRATEGY) | The strategy to use for mapping Camel messages to HBase columns. Supported values: header body. |  | String |
| **CamelMappingStrategyClassName** (common) Constant: [`STRATEGY_CLASS_NAME`](https://javadoc.io/doc/org.apache.camel/camel-hbase/latest/org/apache/camel/component/hbase/HBaseConstants.html#STRATEGY_CLASS_NAME) | The class name of a custom mapping strategy implementation. |  | String |
| **CamelHBaseMarkedRowId** (consumer) Constant: [`HBASE_MARKED_ROW_ID`](https://javadoc.io/doc/org.apache.camel/camel-hbase/latest/org/apache/camel/component/hbase/HBaseConstants.html#HBASE_MARKED_ROW_ID) | The marked row id. |  | byte\[\] |
...
| Name | Description | Default | Type |
| --- | --- | --- | --- |
| **camel.component.hbase.autowired-enabled** | Whether autowiring is enabled. This is used for automatic autowiring options (the option must be marked as autowired) by looking up in the registry to find if there is a single instance of matching type, which then gets configured on the component. This can be used for automatic configuring JDBC data sources, JMS connection factories, AWS Clients, etc. | true | Boolean |
