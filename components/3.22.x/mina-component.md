...
The Mina component is a transport for working with [Apache MINA 2.x](http://mina.apache.org/)
...
> **Warning**
> Be careful with `sync=false` on consumer endpoints. Since camel-mina all consumer exchanges are InOut. This is different to camel-mina.
