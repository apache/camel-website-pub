...
The Netty component in Camel is a socket communication component, based on the [Netty](http://netty.io/) project version 4.  
...
The Netty component supports 76 options, which are listed below.
...
The Netty component supports 11 message header(s), which is/are listed below:
