...
Camel allows [OGNL](http://commons.apache.org/proper/commons-ognl/) (Apache Commons OGNL) to be used as an [Expression](../../../manual/expression.md) or [Predicate](../../../manual/predicate.md) in Camel routes.
