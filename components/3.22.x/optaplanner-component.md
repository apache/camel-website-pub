...
The Optaplanner component solves the planning problem contained in a message with [OptaPlanner](http://www.optaplanner.org/).  
...
| Name | Description | Default | Type |
| --- | --- | --- | --- |
| **configFile** (common) | **Required** Specifies the location to the solver file. If useSolverManager=FALSE, Camel uses this file and create the Solver. If useSolverManager=TRUE and SolverManager is set in the header \\{OptaPlannerConstants.SOLVER\_MANAGER} : this file is ignored by Camel usage of SolverManager. SolverManager can be injected by DI in Quarkus or Spring. |  | String |
...
The OptaPlanner component supports 6 message header(s), which is/are listed below:
...
| **CamelOptaPlannerIsTerminateEarly** (producer) Constant: [`IS_TERMINATE_EARLY`](https://javadoc.io/doc/org.apache.camel/camel-optaplanner/latest/org/apache/camel/component/optaplanner/OptaPlannerConstants.html#IS_TERMINATE_EARLY) | true if terminateEarly has been called since the Solver started. |  | Boolean |
