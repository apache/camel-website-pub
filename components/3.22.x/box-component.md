...
The Box component provides access to all of the Box.com APIs accessible using [https://github.com/box/box-java-sdk](https://github.com/box/box-java-sdk/). It allows producing messages to upload and download files, create, edit, and manage folders, etc. It also supports APIs that allow polling for updates to user accounts and even changes to enterprise accounts, etc.
...
| [**getFileThumbnail**](#_api_files_method_getFileThumbnail) | thumbnail | Retrieves a thumbnail, or smaller image representation, of this file |
...
| Parameter | Description | Type |
| --- | --- | --- |
| **fileId** | The id of the file to get thumbnail | String |
...
| **camel.component.box.encryption-algorithm** | The type of encryption algorithm for JWT. Supported Algorithms: RSA\_SHA\_256 RSA\_SHA\_384 RSA\_SHA\_512. |  | EncryptionAlgorithm |
