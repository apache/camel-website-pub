...
The Zendesk component provides access to all of the zendesk.com APIs accessible using [zendesk-java-client](https://github.com/cloudbees/zendesk-java-client). It allows producing messages to manage Zendesk ticket, user, organization, etc.
...
The 233 method(s) is listed in the table below, followed by detailed syntax for each method. (API methods can have a shorthand alias name which can be used in the syntax instead of the name)
...
| [**createUpload**](#_api_DEFAULT_method_createUpload) |  | 
 ...
 |
| [**createUploadArticle**](#_api_DEFAULT_method_createUploadArticle) |  | Create upload article with inline false |
...
-   java.util.List<org.zendesk.client.v2.model.GroupMembership> getAssignableGroupMemberships(long group\_id);
...
-   java.util.List<org.zendesk.client.v2.model.GroupMembership> getGroupMembershipByUser(long user\_id);
...
-   java.util.List<org.zendesk.client.v2.model.GroupMembership> getGroupMemberships(long group\_id);
...
-   java.util.List<org.zendesk.client.v2.model.OrganizationMembership> getOrganizationMembershipByUser(long user\_id);
