...
[Debezium DB2 Connector](debezium-db2-component.md)

Capture changes from a DB2 database.

[Debezium MongoDB Connector](debezium-mongodb-component.md)

Capture changes from a MongoDB database.

[Debezium MySQL Connector](debezium-mysql-component.md)

Capture changes from a MySQL database.

[Debezium Oracle Connector](debezium-oracle-component.md)
