...
| **camel.component.servicenow.release** | The ServiceNow release to target, default to Helsinki See [https://docs.servicenow.com](https://docs.servicenow.com). |  | ServiceNowRelease |
