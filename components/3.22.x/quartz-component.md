...
The [Quartz](#) component provides a Polling Consumer scheduler which allows to use cron based scheduling for [Polling Consumer](eips/polling-consumer.md) such as the File and FTP consumers.
...
| Parameter | Default | Type | Description |
| --- | --- | --- | --- |
| `quartzScheduler` | `null` | `org.quartz.Scheduler` | To use a custom Quartz scheduler. If none configure then the shared scheduler from the [Quartz](#) component is used. |
