...
The Kubernetes Persistent Volume Claim component is one of [Kubernetes Components](kubernetes-summary.md) which provides a producer to execute Kubernetes Persistent Volume Claims operations.
...
| Name | Description | Default | Type |
| --- | --- | --- | --- |
| **masterUrl** (producer) | **Required** Kubernetes Master url. |  | String |
...
The Kubernetes Persistent Volume Claim component supports 5 message header(s), which is/are listed below:
...
| **CamelKubernetesPersistentVolumesClaimsLabels** (producer) Constant: [`KUBERNETES_PERSISTENT_VOLUMES_CLAIMS_LABELS`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_PERSISTENT_VOLUMES_CLAIMS_LABELS) | The persistent volume claim labels. |  | Map |
| **CamelKubernetesPersistentVolumeClaimName** (producer) Constant: [`KUBERNETES_PERSISTENT_VOLUME_CLAIM_NAME`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_PERSISTENT_VOLUME_CLAIM_NAME) | The persistent volume claim name. |  | String |
| **CamelKubernetesPersistentVolumeClaimSpec** (producer) Constant: [`KUBERNETES_PERSISTENT_VOLUME_CLAIM_SPEC`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_PERSISTENT_VOLUME_CLAIM_SPEC) | The spec for a persistent volume claim. |  | PersistentVolumeClaimSpec |
...
When using kubernetes-persistent-volumes-claims with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
