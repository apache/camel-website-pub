...
The Filter eip supports 2 options, which are listed below.
...
Sometimes you may want to stop continue routing for messages that was filtered. To do this, you can use the [Stop](stop-eip.md) EIP as shown:
