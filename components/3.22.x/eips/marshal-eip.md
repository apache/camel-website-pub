...
Camel has support for message transformation using several techniques. One such technique is [Data Formats](../../4.18.x/dataformats/index.md), where marshal and unmarshal comes from.
