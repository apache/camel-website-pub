...
You can consume a message from one destination, transform it with something like [Velocity](../velocity-component.md), [XQuery](../xquery-component.md), or [AtlasMap](../atlasmap-component.md) and then send it on to another destination.
