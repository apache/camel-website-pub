...
You can transform a message using Camels [Bean Integration](../../../manual/bean-integration.md) to call any method on a bean that performs the message translation:
