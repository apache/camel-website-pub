...
> **Note**
> Camel provides the [Circuit Breaker](circuitBreaker-eip.md) EIP in the route model, which allows to plugin different implementations. Resilience4j is one such implementation.
