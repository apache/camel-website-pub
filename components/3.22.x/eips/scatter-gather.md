...
This is a basic example that only uses basic functionality of the [Recipient List](recipientList-eip.md). For more details how the aggregation works, see the [Recipient List](recipientList-eip.md) documentation.
