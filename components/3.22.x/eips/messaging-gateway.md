...
Camel has several endpoint components that support the Messaging Gateway from the EIP patterns. Components like [Bean](../bean-component.md) provides a way to bind a Java interface to the message exchange.
