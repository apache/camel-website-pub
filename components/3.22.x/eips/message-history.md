...
Notice that the source column is empty, because source location is not enabled. When enabled then, you can see exactly which source file and line number the message routed:
