...
-   [ActiveMQ](../activemq-component.md) or [JMS](../jms-component.md) when using persistent delivery (the default) for working with JMS queues and topics for high performance, clustering and load balancing
...
-   [JPA](../jpa-component.md) for using a database as a persistence layer, or use any of the other database component such as [SQL](../sql-component.md), [JDBC](../jdbc-component.md), or [MyBatis](../mybatis-component.md)
