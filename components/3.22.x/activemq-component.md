...
The ActiveMQ component supports 103 options, which are listed below.
...
| **camel.component.activemq.delivery-mode** | Specifies the delivery mode to be used. Possible values are those defined by javax.jms.DeliveryMode. NON\_PERSISTENT = 1 and PERSISTENT = 2. |  | Integer |
