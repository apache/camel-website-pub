...
-   Encoder and decoder for the [Netty Component](../netty-component.md) component.
...
To expose a Syslog listener service we reuse the existing [Mina Component](../mina-component.md) component or [Netty Component](../netty-component.md) where we just use the `Rfc3164SyslogDataFormat` to marshal and unmarshal messages. Notice that from **Camel 2.14** onwards the syslog dataformat is renamed to `SyslogDataFormat`.
...
To expose a Syslog listener service we reuse the existing [Mina Component](../mina-component.md) component or [Netty Component](../netty-component.md) where we just use the `SyslogDataFormat` to marshal and unmarshal messages
