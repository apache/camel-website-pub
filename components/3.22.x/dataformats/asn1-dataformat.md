...
| --- | --- | --- | --- |
| **unmarshalType** |  | `String` | Class to use when unmarshalling. |
| **usingIterator** | `false` | `Boolean` | If the asn1 file has more than one entry, the setting this option to true, allows working with the splitter EIP, to split the data using an iterator in a streaming mode. |
