...
> **Note**
> This component aims at integrating Cassandra 2.0+ using the CQL3 API (not the Thrift API). It’s based on [Cassandra Java Driver](https://github.com/datastax/java-driver) provided by DataStax.
...
| **resultSetConversionStrategy** (common) | To use a custom class that implements logic for converting ResultSet into message body ALL, ONE, LIMIT\_10, LIMIT\_100…​ |  | ResultSetConversionStrategy |
