...
Since Saxon 9.2, writing extension functions has been supplemented by a new mechanism, referred to as [integrated extension functions](http://www.saxonica.com/html/documentation/extensibility/integratedfunctions) you can now easily use camel as shown in the below example:
