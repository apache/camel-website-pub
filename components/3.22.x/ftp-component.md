...
When consuming from remote FTP server make sure you read the section titled _Default when consuming files_ further below for details related to consuming files.
...
The FTP component supports 10 message header(s), which is/are listed below:
