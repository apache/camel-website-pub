...
The Chunk component allows for processing a message using a [Chunk](http://www.x5software.com/chunk/examples/ChunkExample?loc=en_US) template. This can be ideal when using Templating to generate responses for requests.
...
Chunk component will look for a specific template in _themes_ folder with extensions _.chtml_ or \_.cxml. \_If you need to specify a different folder or extensions, you will need to use the specific options listed above.
...
In this example Chunk component will look for the file _file\_example.chunk_ in the folder _template/subfolder._
