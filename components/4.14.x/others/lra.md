...
The LRA module provides bindings of the [Saga EIP](../eips/saga-eip.md) with any [MicroProfile compatible LRA Coordinator](https://github.com/eclipse/microprofile-lra).
