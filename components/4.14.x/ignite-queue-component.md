...
The Ignite Queue endpoint is one of camel-ignite endpoints that allow you to interact with [Ignite Queue data structures](https://apacheignite.readme.io/docs/queue-and-set).
