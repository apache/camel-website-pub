...
This component provides access to remote file systems over the FTP secure and SFTP protocols.
...
The FTPS component supports 6 options, which are listed below.
...
| **ftpClientKeyStoreParameters** (security) | Set the key store parameters. This is a multi-value option with prefix: ftpClient.keyStore. |  | Map |
| **ftpClientTrustStoreParameters** (security) | Set the trust store parameters. This is a multi-value option with prefix: ftpClient.trustStore. |  | Map |
...
| **securityProtocol** (security) | Set the underlying security protocol. | TLSv1.3 | String |
...
The FTPS component supports 17 message header(s), which is/are listed below:
...
For more information, you can look at [FTP component](ftp-component.md).

## Spring Boot Auto-Configuration

When using ftps with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
