...
| --- | --- | --- | --- |
| **formatRef** (advanced) |  | `String` | The reference format to use, it will be updated with the other format options, the default value is CSVFormat.DEFAULT. |
| **formatName** (advanced) | `DEFAULT` | `Enum` | 
...
| **header** (common) |  | `Array` | To configure the CSV headers. |
...
| **camel.dataformat.csv.format-name** | The name of the format to use, the default value is CSVFormat.DEFAULT. | DEFAULT | String |
