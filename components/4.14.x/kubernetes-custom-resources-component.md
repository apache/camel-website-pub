...
The Kubernetes Custom Resources component is one of [Kubernetes Components](kubernetes-summary.md) which provides a producer to execute Kubernetes Custom Resources operations and a consumer to consume events related to Node objects.
...
The Kubernetes Custom Resources component supports 4 options, which are listed below.
...
The Kubernetes Custom Resources component supports 13 message header(s), which is/are listed below:
...
| **CamelKubernetesCRDInstanceName** (producer) Constant: [`KUBERNETES_CRD_INSTANCE_NAME`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRD_INSTANCE_NAME) | The deployment name. |  | String |
| **CamelKubernetesCRDEventTimestamp** (consumer) Constant: [`KUBERNETES_CRD_EVENT_TIMESTAMP`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRD_EVENT_TIMESTAMP) | Timestamp of the action watched by the consumer. |  | long |
| **CamelKubernetesCRDEventAction** (consumer) Constant: [`KUBERNETES_CRD_EVENT_ACTION`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRD_EVENT_ACTION) | 
...
-   BOOKMARK
 ...
 |  | Action |
| **CamelKubernetesCRDName** (producer) Constant: [`KUBERNETES_CRD_NAME`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRD_NAME) | The Consumer CRD Resource name we would like to watch. |  | String |
| **CamelKubernetesCRDGroup** (producer) Constant: [`KUBERNETES_CRD_GROUP`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRD_GROUP) | The Consumer CRD Resource Group we would like to watch. |  | String |
| **CamelKubernetesCRDScope** (producer) Constant: [`KUBERNETES_CRD_SCOPE`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRD_SCOPE) | The Consumer CRD Resource Scope we would like to watch. |  | String |
| **CamelKubernetesCRDVersion** (producer) Constant: [`KUBERNETES_CRD_VERSION`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRD_VERSION) | The Consumer CRD Resource Version we would like to watch. |  | String |
| **CamelKubernetesCRDPlural** (producer) Constant: [`KUBERNETES_CRD_PLURAL`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRD_PLURAL) | The Consumer CRD Resource Plural we would like to watch. |  | String |
| **CamelKubernetesCRDLabels** (producer) Constant: [`KUBERNETES_CRD_LABELS`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRD_LABELS) | The CRD resource labels. |  | Map |
| **CamelKubernetesCRDInstance** (producer) Constant: [`KUBERNETES_CRD_INSTANCE`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRD_INSTANCE) | The manifest of the CRD resource to create as JSON string. |  | String |
| **CamelKubernetesDeleteResult** (producer) Constant: [`KUBERNETES_DELETE_RESULT`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_DELETE_RESULT) | The result of the delete operation. |  | boolean |
...
When using kubernetes-custom-resources with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
