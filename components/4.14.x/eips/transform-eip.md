...
The example above defines the [Transform](#) EIP that uses a target data type `myDataType`. The given data type may reference a [Transformer](../../../manual/transformer.md) that is able to handle the data type transformation.
