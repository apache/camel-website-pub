...
| **timeout** | Sets minimum time (milliseconds) to wait for missing elements (messages). | 1000 | String |
| **deliveryAttemptInterval** | Sets the interval in milliseconds the stream resequencer will at most wait while waiting for condition of being able to deliver. | 1000 | String |
...
| **comparator** | To use a custom comparator as a org.apache.camel.processor.resequencer.ExpressionResultComparator type. |  | ExpressionResultComparator |
