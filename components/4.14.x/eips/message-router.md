...
The following example shows how to route a request from an input `direct:a` endpoint to either `direct:b`, `direct:c`, or `direct:d` depending on the evaluation of various [Predicates](../../../manual/predicate.md):
