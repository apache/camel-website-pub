...
The Debezium SQL Server Connector component supports 97 options, which are listed below.
...
| **dataQueryMode** (sqlserver) | Controls how the connector queries CDC data. The default is 'function', which means the data is queried by means of calling cdc.fn\_cdc\_get\_all\_changes\_# function. The value of 'direct' makes the connector to query the change tables directly. | function | String |
...
| **camel.component.debezium-sqlserver.data-query-mode** | Controls how the connector queries CDC data. The default is 'function', which means the data is queried by means of calling cdc.fn\_cdc\_get\_all\_changes\_# function. The value of 'direct' makes the connector to query the change tables directly. | function | String |
