...
| **camel.component.servicenow.models** | Defines both request and response models. This is a multi-value option with prefix: model. |  | Map |
...
| **camel.component.servicenow.request-models** | Defines the request model. This is a multi-value option with prefix: request-model. |  | Map |
| **camel.component.servicenow.resource** | The default resource, can be overridden by header CamelServiceNowResource. |  | String |
| **camel.component.servicenow.response-models** | Defines the response model. This is a multi-value option with prefix: response-model. |  | Map |
