...
The Netty HTTP component supports 81 options, which are listed below.
...
| **camel.component.netty-http.key-store-file** | **Deprecated** Client side certificate keystore to be used for encryption. |  | File |
| **camel.component.netty-http.trust-store-file** | **Deprecated** Server side certificate keystore to be used for encryption. |  | File |