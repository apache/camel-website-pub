...
The Netty component supports 77 options, which are listed below.
...
| **trustStoreFile** (security) | **Deprecated** Server side certificate keystore to be used for encryption. |  | File |
...
| Name | Description |
| --- | --- |
| `passphrase` | password setting to use to encrypt/decrypt payloads sent using SSH |
...
| **camel.component.netty.key-store-file** | **Deprecated** Client side certificate keystore to be used for encryption. |  | File |
| **camel.component.netty.trust-store-file** | **Deprecated** Server side certificate keystore to be used for encryption. |  | File |