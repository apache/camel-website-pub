...
> **Warning**
> **Deprecated:** This splunk is deprecated and may be removed in a future release.
...
> **Note**
> This component is deprecated since Camel 4.19 and will be removed in a future release. For event ingestion (producer) use cases, consider migrating to [Splunk HEC](splunk-hec-component.md), which uses the standard HTTP Event Collector and has no dependency on the unmaintained Splunk Java SDK. Note that Splunk HEC is producer-only and does not support consumer (search) operations.
