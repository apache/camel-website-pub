...
| **CamelGoogleFirestoreChangeType** (consumer) Constant: [`CHANGE_TYPE`](https://javadoc.io/doc/org.apache.camel/camel-google-firestore/latest/org/apache/camel/component/google/firestore/GoogleFirestoreConstants.html#CHANGE_TYPE) | The type of change reported by the realtime listener: ADDED, MODIFIED or REMOVED. Only set when realtimeUpdates is enabled. |  | String |
