...
The Kubernetes Persistent Volume component is one of [Kubernetes Components](kubernetes-summary.md) which provides a producer to execute Kubernetes Persistent Volume (PV) operations.
