...
| --- | --- | --- | --- |
| **connectTimeout** (common) | Connect timeout. |  | Duration |
...
| **readTimeout** (common) | Read timeout. |  | Duration |
| **tags** (common) | Set tags. You can separate multiple tags by comma. |  | String |
| **url** (common) | The Consul agent URL. |  | String |
| **valueAsString** (common) | Default to transform values retrieved from Consul i.e. on KV endpoint to string. | false | boolean |
| **writeTimeout** (common) | Write timeout. |  | Duration |
...
| **consulClient** (advanced) | **Autowired** The consul client to use. |  | Consul |
