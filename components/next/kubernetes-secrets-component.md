...
The Kubernetes Secrets component supports 6 message header(s), which is/are listed below:
...
When using kubernetes-secrets with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
