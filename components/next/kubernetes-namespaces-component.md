...
The Kubernetes Namespaces component supports 6 message header(s), which is/are listed below:
...
When using kubernetes-namespaces with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
