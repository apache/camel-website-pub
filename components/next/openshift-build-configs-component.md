...
The OpenShift Build Config component supports the following options which are listed below.
...
The OpenShift Build Config component supports the following message header(s), which is/are listed below:
