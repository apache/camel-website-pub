...
The [Hazelcast](http://www.hazelcast.com/) Set component is one of Camel Hazelcast Components which allows you to access a Hazelcast distributed set.
...
The Hazelcast Set component supports 6 message header(s), which is/are listed below:
...
When using hazelcast-set with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
