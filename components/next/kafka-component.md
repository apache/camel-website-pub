...
| **queueBufferingMaxMessages** (producer) | **Deprecated** Deprecated: this option has no effect. Use bufferMemorySize or maxBlockMs instead. | 10000 | Integer |
...
> **Tip**
> The header name is `CamelKafkaManualCommit`.
...
> **Tip**
> The header name is `CamelKafkaKey`.
