...
[Camel Properties Component](../../4.18.x/properties-component.md) [Spring Cloud Config](https://spring.io/projects/spring-cloud-config) [Using Property Placeholders](../../../manual/using-propertyplaceholder.md)