...
The microprofile-health component is used for bridging [Eclipse MicroProfile Health](https://microprofile.io/project/eclipse/microprofile-health) checks with Camel’s own Health Check API.
