...
Technically speaking Camel transport for CXF is a component which implements the [CXF transport API](https://cxf.apache.org/docs/cxf-architecture.html#CXFArchitecture-Transports) with the Camel core library. This allows you to easily use Camel’s routing engine and integration patterns support together with your CXF services.
