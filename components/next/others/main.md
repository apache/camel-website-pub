...
| **camel.server.mcpEnabled** | Whether to expose ai-tool routes as MCP tools and ai-resource routes as MCP resources over streamable HTTP. Requires camel-mcp-server on the classpath. By default, the MCP server is not enabled. | false | boolean |
