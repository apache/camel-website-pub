...
| **camel.opentelemetry2.excludePatterns** | Adds an exclude pattern that will disable tracing for Camel messages that matches the pattern. Multiple patterns can be separated by comma. |  | String |
...
| **camel.opentelemetry2.traceProcessors** | Setting this to true will create new OpenTelemetry Spans for each Camel Processors. Use the excludePattern property to filter out Processors. | false | boolean |
...
| **camel.telemetryDev.excludePatterns** | Adds an exclude pattern that will disable tracing for Camel messages that matches the pattern. Multiple patterns can be separated by comma. |  | String |
| **camel.telemetryDev.traceFormat** | The output format for traces. |  | String |
| **camel.telemetryDev.traceProcessors** | Setting this to true will create new TelemetrySimple Spans for each Camel Processors. Use the excludePattern property to filter out Processors. | false | boolean |
