...
> **Warning**
> **Deprecated:** This tracing is deprecated and may be removed in a future release.
...
-   [`camel-opentelemetry`](opentelemetry.md)
    
-   [`camel-observation`](observation.md)
    

> **Note**
> this component and the related implementations are deprecated since version 4.19.0. Please, use [`camel-telemetry`](telemetry.md) components instead.
...
> **Note**
> This part is subject to change in the future.
...
> **Note**
> more information about each decorator in the [tracing component code repository](https://github.com/apache/camel/tree/bfadc5d7c2dd904942cef247472bcc2793445f2b/components/camel-tracing/src/main/java/org/apache/camel/tracing/decorators).
...
> **Note**
> this feature is planned to be generic in future Camel releases.
