...
| [AWS S3 - Consumer Examples](aws2-s3-consumer-examples.md) |  |  |  |  |
| [AWS S3 - Producer Operations](aws2-s3-producer-operations.md) |  |  |  |  |
| [AWS S3 - Streaming Upload](aws2-s3-streaming.md) |  |  |  |  |
...
| [Azure Storage Blob - Consumer Examples](azure-storage-blob-consumer.md) |  |  |  |  |
| [Azure Storage Blob - Producer Operations](azure-storage-blob-operations.md) |  |  |  |  |
...
| [Docling - Asynchronous Processing](docling-async-processing.md) |  |  |  |  |
| [Docling - Batch Processing](docling-batch-processing.md) |  |  |  |  |
...
| [LangChain4j Agent - Input and Output Guardrails](langchain4j-agent-guardrails.md) |  |  |  |  |
...
| [Micrometer Prometheus](micrometer-prometheus.md) | camel-micrometer-prometheus | Stable | 4.3 | Camel Micrometer Prometheus for Camel Main |
| [Microprofile Config](microprofile-config.md) | camel-microprofile-config | Stable | 3.0 | Bridging Eclipse MicroProfile Config with Camel properties |
| [Microprofile Fault Tolerance](microprofile-fault-tolerance.md) | camel-microprofile-fault-tolerance | Stable | 3.3 | Circuit Breaker EIP using MicroProfile Fault Tolerance |
| [Microprofile Health](microprofile-health.md) | camel-microprofile-health | Stable | 3.0 | Expose Camel health checks via MicroProfile Health |
| [MINA SFTP Authentication](mina-sftp-authentication.md) |  |  |  |  |
| [MINA SFTP Migration from JSch](mina-sftp-migration.md) |  |  |  |  |
...
| [Opentelemetry2](opentelemetry2.md) | camel-opentelemetry2 | Stable | 4.11 | Implementation of Camel Opentelemetry based on the Camel Telemetry spec |
...
| [Resilience4j Micrometer](resilience4j-micrometer.md) | camel-resilience4j-micrometer | Stable | 4.15 | Micrometer statistics for Resilience4j |
| [Resourceresolver Github](resourceresolver-github.md) | camel-resourceresolver-github | Stable | 3.11 | Resource resolver to load files from GitHub |
| [RxJava](rxjava.md) | camel-rxjava | Stable | 2.22 | RxJava based back-end for Camel’s reactive streams component |
| [Salesforce - Bulk API](salesforce-bulk-api.md) |  |  |  |  |
| [Salesforce - Reports API](salesforce-reports.md) |  |  |  |  |
| [Salesforce - REST API](salesforce-rest-api.md) |  |  |  |  |
| [Salesforce - Streaming and Pub/Sub](salesforce-streaming.md) |  |  |  |  |
| [Shiro](shiro.md) | camel-shiro | Stable | 2.5 | Security using Shiro |
| [Spring Cloud Config](spring-cloud-config.md) | camel-spring-cloud-config | Stable | 4.12 | Camel Spring Cloud Config support |
| [Spring Main](spring-main.md) | camel-spring-main | Stable | 3.2 | Camel Spring Main support |
| [Spring Security](spring-security.md) | camel-spring-security | Stable | 2.3 | Security using Spring Security |
| [Spring XML](spring-xml.md) | camel-spring-xml | Stable | 3.9 | Camel Spring with XML DSL |
| [Springdoc](springdoc.md) | openapi-java |  | 3.14 | Springdoc Swagger UI for openapi-java in spring boot |
| [Telemetry](telemetry.md) | camel-telemetry | Preview | 4.11 | Distributed telemetry common interfaces |
| [Telemetry Dev](telemetry-dev.md) | camel-telemetry-dev | Preview | 4.11 | Basic implementation of Camel Telemetry useful for development purposes |
| [Test JUnit5](test-junit5.md) | camel-test-junit5 | Stable | 3.0 | Camel unit testing with JUnit 5 |
| [Test JUnit6](test-junit6.md) | camel-test-junit6 | Stable | 4.17 | Camel unit testing with JUnit 6 |
| [Test Main JUnit5](test-main-junit5.md) | camel-test-main-junit5 | Stable | 3.16 | Camel unit testing with Main and JUnit 5 |
