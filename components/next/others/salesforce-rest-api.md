...
-   [apexCall](../salesforce-component.html#apexCall) - Executes a user defined APEX REST API call.
...
When using the [Camel Salesforce Maven Plugin](../salesforce-component.html#MavenPlugin), binary fields are automatically generated for blob fields:
