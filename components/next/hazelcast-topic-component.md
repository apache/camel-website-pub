...
The [Hazelcast](http://www.hazelcast.com/) Topic component is one of Camel Hazelcast Components which allows you to access Hazelcast distributed topic.
...
The Hazelcast Topic component supports 6 message header(s), which is/are listed below:
...
When using hazelcast-topic with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
