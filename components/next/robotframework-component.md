...
The **robotframework:** component allows for processing camel exchanges in acceptance test suites which are already implemented with its own DSL. The depending keyword libraries that can be used inside test suites implemented in Robot DSL, could have been implemented either via Java or Python.
...
The Robot Framework component supports the following options which are listed below.
...
| **argumentFiles** (common) | A text String to read more arguments from. |  | String |
...
| **debugFile** (common) | A debug String that is written during execution. |  | String |
...
| **log** (common) | Sets the path to the generated log String. |  | String |
...
| **output** (common) | Sets the path to the generated output String. |  | String |
| **outputDirectory** (common) | Configures where generated reports are to be placed. |  | String |
| **randomize** (common) | Sets the test execution order to be randomized. Valid values are all, suite, and test. |  | String |
| **report** (common) | Sets the path to the generated report String. |  | String |
...
| **runFailed** (common) | Re-run failed tests, based on output.xml String. |  | String |
...
| **warnOnSkippedFiles** (common) | Show a warning when an invalid String is skipped. | false | boolean |
| **xunitFile** (common) | Sets the path to the generated XUnit compatible result String, relative to outputDirectory. The String is in xml format. By default, the String name is derived from the testCasesDirectory parameter, replacing blanks in the directory name by underscores. |  | String |
...
| Name | Description | Default | Type |
| --- | --- | --- | --- |
| **resourceUri** (common) | **Required** Path to the resource. You can prefix with: classpath, file, http, ref, or bean. classpath, file and http loads the resource using these protocols (classpath is default). ref will lookup the resource in the registry. bean will call a method on a bean to be used as the resource. For bean you can specify the method name after dot, eg bean:myBean.myMethod. |  | String |
...
The Robot Framework component supports the following message header(s), which is/are listed below:

   
| Name | Description | Default | Type |
| --- | --- | --- | --- |
| **CamelRobotVariables** (common) Constant: [`CAMEL_ROBOT_VARIABLES`](https://javadoc.io/doc/org.apache.camel/camel-robotframework/latest/org/apache/camel/component/robotframework/RobotFrameworkCamelConstants.html#CAMEL_ROBOT_VARIABLES) | The robot variables. |  | List |
| **CamelRobotReturnCode** (common) Constant: [`CAMEL_ROBOT_RETURN_CODE`](https://javadoc.io/doc/org.apache.camel/camel-robotframework/latest/org/apache/camel/component/robotframework/RobotFrameworkCamelConstants.html#CAMEL_ROBOT_RETURN_CODE) | The return code. |  | Integer |
| **CamelRobotResourceUri** (common) Constant: [`CAMEL_ROBOT_RESOURCE_URI`](https://javadoc.io/doc/org.apache.camel/camel-robotframework/latest/org/apache/camel/component/robotframework/RobotFrameworkCamelConstants.html#CAMEL_ROBOT_RESOURCE_URI) | The new resource URI. |  | String |
