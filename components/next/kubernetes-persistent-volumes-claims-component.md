...
The Kubernetes Persistent Volume Claim component is one of [Kubernetes Components](kubernetes-summary.md) which provides a producer to execute Kubernetes Persistent Volume Claims (PVC) operations.
