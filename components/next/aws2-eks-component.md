...
The AWS Elastic Kubernetes Service (EKS) component supports the following options which are listed below.
...
The AWS Elastic Kubernetes Service (EKS) component supports the following message header(s), which is/are listed below:
