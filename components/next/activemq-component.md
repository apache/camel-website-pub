...
The ActiveMQ 5.x component supports the following options which are listed below.
...
The ActiveMQ 5.x component supports the following message header(s), which is/are listed below:
