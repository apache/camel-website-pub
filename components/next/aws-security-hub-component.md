...
The AWS Security Hub component supports the following options which are listed below.
...
The AWS Security Hub component supports the following message header(s), which is/are listed below:
