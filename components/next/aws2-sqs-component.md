...
The AWS Simple Queue Service (SQS) component supports the following options which are listed below.
...
The AWS Simple Queue Service (SQS) component supports the following message header(s), which is/are listed below:
