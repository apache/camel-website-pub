...
The PQC DataFormat can be integrated with the [Key Lifecycle Manager](../others/pqc-key-lifecycle.md) for automated key management:
...
-   **Key Rotation**: Regularly rotate keys using the [Key Lifecycle Manager](../others/pqc-key-lifecycle.md)
