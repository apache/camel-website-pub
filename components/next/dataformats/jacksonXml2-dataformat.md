...
The Jackson XML 2 dataformat supports 17 options, which are listed below.
...
When using jacksonXml2 with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
