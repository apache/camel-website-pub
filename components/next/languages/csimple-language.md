...
> **Warning**
> **Deprecated:** This csimple is deprecated and may be removed in a future release.

**Since Camel 3.7**

> **Warning**
> The CSimple (compiled simple) language is **deprecated** (since Camel 4.19) and will be removed in a future release. Use the [Simple](simple-language.md) language instead.
...
> **Note**
> The ternary operator (`? :`) IS supported in csimple. The limitation above refers only to the null-safe operator used in OGNL expressions (e.g., `${body?.address}`).
