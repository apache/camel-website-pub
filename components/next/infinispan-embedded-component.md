...
-   COMPUTEASYNC
 ...
 |  | InfinispanOperation |
| **CamelInfinispanOperationResult** (producer) Constant: [`RESULT`](https://javadoc.io/doc/org.apache.camel/camel-infinispan-embedded/latest/org/apache/camel/component/infinispan/InfinispanConstants.html#RESULT) | **Deprecated** The name of the header whose value is the result. Deprecation note: Never set nor read by the component. Use CamelInfinispanOperationResultHeader to choose the header that carries the result of an operation. |  | String |
...
-   DAYS
 ...
 |  | TimeUnit |
| **CamelInfinispanIgnoreReturnValues** (producer) Constant: [`IGNORE_RETURN_VALUES`](https://javadoc.io/doc/org.apache.camel/camel-infinispan-embedded/latest/org/apache/camel/component/infinispan/InfinispanConstants.html#IGNORE_RETURN_VALUES) | Signals that a write operation’s return value will be ignored, so reading the existing value from a store or from a remote node is not necessary. | false | boolean |
