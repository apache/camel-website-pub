...
| **customHttpClient** (advanced) | Set custom HTTP client for authenticated access. |  | OkHttpClient |
...
| Name | Description | Default | Type |
| --- | --- | --- | --- |
| **CamelMinioBucketName** (common) Constant: [`BUCKET_NAME`](https://javadoc.io/doc/org.apache.camel/camel-minio/latest/org/apache/camel/component/minio/MinioConstants.html#BUCKET_NAME) | Consumer: The name of the bucket in which this object is contained. |  | String |
...
| **CamelMinioOverrideBucketName** (common) Constant: [`OVERRIDE_BUCKET_NAME`](https://javadoc.io/doc/org.apache.camel/camel-minio/latest/org/apache/camel/component/minio/MinioConstants.html#OVERRIDE_BUCKET_NAME) | The bucket Name to override which this object will be stored or which will be used for the current operation or in which this object is contained. |  | String |
> **Note**
...
With the option `autoCreateBucket` users are able to avoid the auto-creation of a Minio Bucket in case it doesn’t exist. The default for this option is `true`. If set to false, any operation on a not-existent bucket in Minio won’t be successful, and an error will be returned.
...
| **camel.component.minio.health-check-consumer-enabled** | Used for enabling or disabling all consumer based health checks from this component. | true | Boolean |
...
| **camel.component.minio.modified-since** | Set modified since parameter for get object(s). |  | ZonedDateTime |
...
| **camel.component.minio.un-modified-since** | Set un modified since parameter for get object(s). |  | ZonedDateTime |
