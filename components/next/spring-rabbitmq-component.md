...
| **retry** (consumer (advanced)) | Custom retry configuration to use. If this is configured then the other settings such as maximumRetryAttempts for retry are not in use. |  | StatelessRetryOperationsInterceptor |
