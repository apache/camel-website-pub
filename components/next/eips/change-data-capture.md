...
Camel integrates with [Debezium](https://debezium.io/), which is a CDC system. There are a number of Camel Debezium components that work with different databases such as MySQL, Postgres, and MongoDB.

## Example

See the [Camel Debezium Example](https://github.com/apache/camel-examples/tree/main/debezium) for more details.