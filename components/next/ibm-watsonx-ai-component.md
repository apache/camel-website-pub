...
The IBM watsonx.ai component supports the following options which are listed below.
...
The IBM watsonx.ai component supports the following message header(s), which is/are listed below:
...
| **CamelIBMWatsonxAiModelId** (producer) Constant: [`MODEL_ID`](https://javadoc.io/doc/org.apache.camel/camel-ibm-watsonx-ai/latest/org/apache/camel/component/ibm/watsonx/ai/WatsonxAiConstants.html#MODEL_ID) | The model ID used for the request, reported on the response. |  | String |
