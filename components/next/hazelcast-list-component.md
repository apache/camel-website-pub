...
The Hazelcast List component supports the following options which are listed below.
...
The Hazelcast List component supports the following message header(s), which is/are listed below:
