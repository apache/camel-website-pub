...
The [Hazelcast](http://www.hazelcast.com/) List component is one of Camel Hazelcast Components which allows you to access a Hazelcast distributed list.
...
The Hazelcast List component supports 7 message header(s), which is/are listed below:
...
| **CamelHazelcastObjectIndex** (producer) Constant: [`OBJECT_POS`](https://javadoc.io/doc/org.apache.camel/camel-hazelcast/latest/org/apache/camel/component/hazelcast/HazelcastConstants.html#OBJECT_POS) | The index of the object. |  | Integer |
...
When using hazelcast-list with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
