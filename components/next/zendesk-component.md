...
-   GET\_TICKET\_FROM\_SEARCH\_WITH\_EXPORT
    
-   GET\_TICKET\_FROM\_SEARCH\_WITH\_EXPORT\_1
...
| [**getTicketForms**](#_api_DEFAULT_method_getTicketForms) |  | 
 ...
 |
| [**getTicketFromSearchWithExport**](#_api_DEFAULT_method_getTicketFromSearchWithExport) |  | 
...
#### Method getTicketFromSearchWithExport

Signatures:

-   Iterable<org.zendesk.client.v2.model.Ticket> getTicketFromSearchWithExport(String searchTerm);
    
-   Iterable<org.zendesk.client.v2.model.Ticket> getTicketFromSearchWithExport(String searchTerm, int pageSize);
    

The zendesk/getTicketFromSearchWithExport API method has the parameters listed in the table below:
