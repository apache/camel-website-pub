...
The IEC 60870 Client component supports the following options which are listed below.
...
The IEC 60870 Client component supports the following message header(s), which is/are listed below:
