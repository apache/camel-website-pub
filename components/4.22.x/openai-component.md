...
| **storeFullResponse** (producer) | Store the full SDK response in non-streaming mode: chat-completion uses exchange property 'CamelOpenAIResponse'; responses uses 'CamelOpenAIResponsesResponse'; embeddings uses 'CamelOpenAIEmbeddingsResponse'; audio transcription uses 'CamelOpenAIAudioTranscriptionResponse'; audio translation uses 'CamelOpenAIAudioTranslationResponse'. | false | boolean |
