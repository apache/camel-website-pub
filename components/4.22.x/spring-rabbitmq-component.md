...
| **replyTimeout** (producer) | Specify the timeout in milliseconds to be used when waiting for a reply message when doing request/reply messaging. The default value is 30 seconds. A negative value indicates an indefinite timeout. | 30000 | long |
