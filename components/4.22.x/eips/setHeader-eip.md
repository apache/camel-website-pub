...
| **name** | **Required** Name of message header to set a new value. The simple language can be used to define a dynamic evaluated header name. Otherwise a constant name will be used. |  | String |
