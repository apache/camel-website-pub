...
It is of course also possible to set a variable with a value from anything on the `Exchange` such as the message body, where we use the [Simple](../languages/simple-language.md) language to refer to the message body:
