...
This is usable for quickly whirling up some code. If the code in the inner class gets a bit more complicated, it is advised to refactor into a separate class.