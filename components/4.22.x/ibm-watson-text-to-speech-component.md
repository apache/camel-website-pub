...
The IBM Watson Text to Speech component supports the following options which are listed below.
...
The IBM Watson Text to Speech component supports the following message header(s), which is/are listed below:
