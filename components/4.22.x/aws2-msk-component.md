...
The AWS Managed Streaming for Apache Kafka (MSK) component supports the following options which are listed below.
...
The AWS Managed Streaming for Apache Kafka (MSK) component supports the following message header(s), which is/are listed below:
