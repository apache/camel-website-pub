...
The Kubernetes Replication Controller component supports the following options which are listed below.
...
The Kubernetes Replication Controller component supports the following message header(s), which is/are listed below:
