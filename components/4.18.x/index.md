...
| [Once](once-component.md) | camel-once | Preview | 4.17 | Trigger a single message only once at startup (useful for development and testing purposes). |
...
Number of Non-Core Components: 370 in 297 JAR artifacts (11 deprecated)
...
| [AWS Eventbridge](aws2-eventbridge-component.md) | camel-aws2-eventbridge | Stable | 3.6 | Send events to AWS Eventbridge cluster instances. |
...
| [AWS Parameter Store](aws-parameter-store-component.md) | camel-aws-parameter-store | Preview | 4.17 | Manage parameters using AWS Systems Manager (SSM) Parameter Store. |
...
| [AWS Rekognition](aws2-rekognition-component.md) | camel-aws2-rekognition | Preview | 4.17 | Manage and invoke AWS Rekognition. |
...
| [AWS S3 Vectors](aws2-s3-vectors-component.md) | camel-aws2-s3-vectors | Preview | 4.17 | Store and query vector embeddings using AWS S3 Vectors with similarity search. |
...
| [Couchbase](couchbase-component.md) | camel-couchbase | Stable | 2.19 | Query Couchbase Views with a poll strategy and/or perform various operations against Couchbase databases. |
...
| [CyberArk Vault](cyberark-vault-component.md) | camel-cyberark-vault | Preview | 4.17 | Retrieve secrets from CyberArk Conjur Vault. |
...
| [Google PubSub Lite](google-pubsub-lite-component.md) | camel-google-pubsub-lite | Stable-deprecated | 4.6 | Send and receive messages to/from Google Cloud Platform PubSub Lite Service. |
...
| [Google Vertex AI](google-vertexai-component.md) | camel-google-vertexai | Preview | 4.17 | Interact with Google Cloud Vertex AI generative models. |
...
| [Hazelcast Atomic Number](hazelcast-atomicvalue-component.md) | camel-hazelcast | Stable | 2.7 | Increment, decrement, set, etc. Hazelcast atomic number (a grid wide number). |
...
| [IBM Watson Speech to Text](ibm-watson-speech-to-text-component.md) | camel-ibm-watson-speech-to-text | Preview | 4.17 | Convert speech audio to text using IBM Watson Speech to Text |
| [IBM Watson Text to Speech](ibm-watson-text-to-speech-component.md) | camel-ibm-watson-text-to-speech | Preview | 4.17 | Convert text to natural-sounding speech using IBM Watson Text to Speech |
...
| [Nitrite](nitrite-component.md) | camel-nitrite | Stable-deprecated | 3.0 | Access Nitrite databases. |
...
| [OpenAI](openai-component.md) | camel-openai | Preview | 4.17 | OpenAI endpoint for chat completion and embeddings. |
...
| [OpenTelemetry Metrics](opentelemetry-metrics-component.md) | camel-opentelemetry-metrics | Preview | 4.17 | Camel metrics based on the Camel Telemetry spec |
...
| [REST OpenApi](rest-openapi-component.md) | camel-rest-openapi | Stable | 3.1 | To call REST services using OpenAPI specification as contract. |
...
| [Service](service-component.md) | camel-service | Stable-deprecated | 2.22 | Register a Camel endpoint to a Service Registry (such as Consul, Etcd) and delegate to it. |
...
| [Splunk](splunk-component.md) | camel-splunk | Stable | 2.13 | Publish or search for events in Splunk. |
...
| [Spring AI Chat](spring-ai-chat-component.md) | camel-spring-ai-chat | Preview | 4.17 | Perform chat operations using Spring AI. |
| [Spring AI Embeddings](spring-ai-embeddings-component.md) | camel-spring-ai-embeddings | Preview | 4.17 | Spring AI Embeddings |
| [Spring AI Tools](spring-ai-tools-component.md) | camel-spring-ai-tools | Preview | 4.17 | Spring AI Tools and Function Calling Features |
| [Spring AI Vector Store](spring-ai-vector-store-component.md) | camel-spring-ai-vector-store | Preview | 4.17 | Spring AI Vector Store |
...
| [TorchServe](torchserve-component.md) | camel-torchserve | Preview-deprecated | 4.9 | Provide access to PyTorch TorchServe servers to run inference with PyTorch models remotely |
...
| [Zeebe](zeebe-component.md) | camel-zeebe | Preview | 3.21 | Zeebe component which integrates with Camunda Zeebe to interact with the API. |
