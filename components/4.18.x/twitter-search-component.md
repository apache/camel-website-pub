...
| Name | Description | Default | Type |
| --- | --- | --- | --- |
| **CamelTwitterKeywords** (common) Constant: [`TWITTER_KEYWORDS`](https://javadoc.io/doc/org.apache.camel/camel-twitter/latest/org/apache/camel/component/twitter/TwitterConstants.html#TWITTER_KEYWORDS) | The keywords to search. |  | String |
| **CamelTwitterSearchLanguage** (common) Constant: [`TWITTER_SEARCH_LANGUAGE`](https://javadoc.io/doc/org.apache.camel/camel-twitter/latest/org/apache/camel/component/twitter/TwitterConstants.html#TWITTER_SEARCH_LANGUAGE) | The lang string ISO\_639-1 which will be used for searching. |  | String |
| **CamelTwitterCount** (common) Constant: [`TWITTER_COUNT`](https://javadoc.io/doc/org.apache.camel/camel-twitter/latest/org/apache/camel/component/twitter/TwitterConstants.html#TWITTER_COUNT) | Limiting number of results per page. |  | Integer |
| **CamelTwitterNumberOfPages** (common) Constant: [`TWITTER_NUMBER_OF_PAGES`](https://javadoc.io/doc/org.apache.camel/camel-twitter/latest/org/apache/camel/component/twitter/TwitterConstants.html#TWITTER_NUMBER_OF_PAGES) | The number of pages result which you want camel-twitter to consume. |  | Integer |
| **CamelTwitterSinceId** (common) Constant: [`TWITTER_SINCEID`](https://javadoc.io/doc/org.apache.camel/camel-twitter/latest/org/apache/camel/component/twitter/TwitterConstants.html#TWITTER_SINCEID) | The last tweet id which will be used for pulling the tweets. It is useful when the camel route is restarted after a long-running. |  | Long |
| **CamelTwitterMaxId** (common) Constant: [`TWITTER_MAXID`](https://javadoc.io/doc/org.apache.camel/camel-twitter/latest/org/apache/camel/component/twitter/TwitterConstants.html#TWITTER_MAXID) | If specified, returns tweets with status ids less than the given id. |  | Long |
...
When using twitter-search with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
