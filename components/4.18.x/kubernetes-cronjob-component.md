...
The Kubernetes CronJob component is one of [Kubernetes Components](kubernetes-summary.md) which provides a producer to execute kubernetes CronJob operations.
...
The Kubernetes Cronjob component supports 3 options, which are listed below.
...
The Kubernetes Cronjob endpoint is configured using URI syntax:
...
The Kubernetes Cronjob component supports 5 message header(s), which is/are listed below:
...
| **CamelKubernetesCronJobLabels** (producer) Constant: [`KUBERNETES_CRON_JOB_LABELS`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRON_JOB_LABELS) | The Cronjob labels. |  | Map |
| **CamelKubernetesCronJobName** (producer) Constant: [`KUBERNETES_CRON_JOB_NAME`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRON_JOB_NAME) | The Cronjob name. |  | String |
| **CamelKubernetesCronJobSpec** (producer) Constant: [`KUBERNETES_CRON_JOB_SPEC`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRON_JOB_SPEC) | The spec for a Job. |  | CronJobSpec |
| **CamelKubernetesCronJobAnnotations** (producer) Constant: [`KUBERNETES_CRON_JOB_ANNOTATIONS`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_CRON_JOB_ANNOTATIONS) | The Cron Job annotations. |  | Map |
...
When using kubernetes-cronjob with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
