...
The Kubernetes Pods component is one of [Kubernetes Components](kubernetes-summary.md) which provides a producer to execute Kubernetes Pods operations and a consumer to consume events related to Pod Objects.
...
The Kubernetes Pods component supports 4 options, which are listed below.
...
The Kubernetes Pods component supports 7 message header(s), which is/are listed below:
...
| **CamelKubernetesPodsLabels** (producer) Constant: [`KUBERNETES_PODS_LABELS`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_PODS_LABELS) | The pod labels. |  | Map |
| **CamelKubernetesPodName** (producer) Constant: [`KUBERNETES_POD_NAME`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_POD_NAME) | The pod name. |  | String |
| **CamelKubernetesPodSpec** (producer) Constant: [`KUBERNETES_POD_SPEC`](https://javadoc.io/doc/org.apache.camel/camel-kubernetes/latest/org/apache/camel/component/kubernetes/KubernetesConstants.html#KUBERNETES_POD_SPEC) | The spec for a pod. |  | PodSpec |
...
When using kubernetes-pods with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
