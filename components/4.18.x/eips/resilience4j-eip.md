...
You can fine-tune Resilience4j by the many [Resilience4j Configuration](resilience4jConfiguration-eip.md) options.
...
> **Note**
> Camel provides the [Circuit Breaker](circuitBreaker-eip.md) EIP in the route model, which allows to plug in different implementations. Resilience4j is one such implementation.
