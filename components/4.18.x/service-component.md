...
> **Warning**
> **Deprecated:** This service is deprecated and may be removed in a future release.
...
| Name | Description | Default | Type |
| --- | --- | --- | --- |
| **delegateUri** (consumer) | **Required** The endpoint uri to expose as service. |  | String |
