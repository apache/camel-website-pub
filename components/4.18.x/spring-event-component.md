...
> **Note**
> At the moment, there are no options for this component. That may change in future releases, so please check back.
...
When using spring-event with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
