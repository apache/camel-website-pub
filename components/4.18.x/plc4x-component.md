...
| **tags** (consumer) | Tags as key/values from the Map to use in query. This is a multi-value option with prefix: tag. |  | Map |
...
The list of supported protocols is growing in [PLC4X](https://plc4x.apache.org). There are good chances that they will work out of the box just by adding the driver dependency. You can check [here](https://plc4x.apache.org/users/protocols/index.md).
