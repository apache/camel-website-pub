...
The Ignite Messaging endpoint is one of camel-ignite endpoints that allow you to send and consume messages from an [Ignite topic](https://apacheignite.readme.io/docs/messaging).
