...
The Ignite Sets endpoint is one of camel-ignite endpoints that allows you to interact with [Ignite Set data structures](https://apacheignite.readme.io/docs/queue-and-set).
