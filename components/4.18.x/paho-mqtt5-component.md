...
| **manualAcksEnabled** (consumer) | Sets whether to use manual acknowledgements for the client. By default, this is false and message will be automatically acknowledged upon received by Camel. If set to true, the acknowledgement is deferred to be acknowledged by Camel at the end of processing the message. This ensures that only successfully processed messages is acknowledged, and allows to rollback and retry the message in case of an error during routing in Camel. | false | boolean |
...
| Name | Description | Default | Type |
| --- | --- | --- | --- |
| **CamelMqttTopic** (consumer) Constant: [`MQTT_TOPIC`](https://javadoc.io/doc/org.apache.camel/camel-paho-mqtt5/latest/org/apache/camel/component/paho/mqtt5/PahoMqtt5Constants.html#MQTT_TOPIC) | The name of the topic. |  | String |
| **CamelMqttQoS** (consumer) Constant: [`MQTT_QOS`](https://javadoc.io/doc/org.apache.camel/camel-paho-mqtt5/latest/org/apache/camel/component/paho/mqtt5/PahoMqtt5Constants.html#MQTT_QOS) | The quality of service of the incoming message. |  | Integer |
| **CamelPahoMqtt5Qos** (producer) Constant: [`CAMEL_PAHO_MSG_QOS`](https://javadoc.io/doc/org.apache.camel/camel-paho-mqtt5/latest/org/apache/camel/component/paho/mqtt5/PahoMqtt5Constants.html#CAMEL_PAHO_MSG_QOS) | The client quality of service level (0-2). |  | Integer |
| **CamelPahoMqtt5Retained** (producer) Constant: [`CAMEL_PAHO_MSG_RETAINED`](https://javadoc.io/doc/org.apache.camel/camel-paho-mqtt5/latest/org/apache/camel/component/paho/mqtt5/PahoMqtt5Constants.html#CAMEL_PAHO_MSG_RETAINED) | Retain option. |  | Boolean |
| **CamelPahoMqtt5OverrideTopic** (producer) Constant: [`CAMEL_PAHO_OVERRIDE_TOPIC`](https://javadoc.io/doc/org.apache.camel/camel-paho-mqtt5/latest/org/apache/camel/component/paho/mqtt5/PahoMqtt5Constants.html#CAMEL_PAHO_OVERRIDE_TOPIC) | The name of topic to override and send to instead of topic specified on endpoint. |  | String |
| **CamelPahoMqtt5MsgProperties** (producer) Constant: [`CAMEL_PAHO_MSG_PROPERTIES`](https://javadoc.io/doc/org.apache.camel/camel-paho-mqtt5/latest/org/apache/camel/component/paho/mqtt5/PahoMqtt5Constants.html#CAMEL_PAHO_MSG_PROPERTIES) | Consumer: The properties set on the incoming message. Producer: The properties to be set on the outgoing message. |  | MqttProperties |
...
| **camel.component.paho-mqtt5.manual-acks-enabled** | Sets whether to use manual acknowledgements for the client. By default, this is false and message will be automatically acknowledged upon received by Camel. If set to true, the acknowledgement is deferred to be acknowledged by Camel at the end of processing the message. This ensures that only successfully processed messages is acknowledged, and allows to rollback and retry the message in case of an error during routing in Camel. | false | Boolean |
...
| **camel.component.paho-mqtt5.persistence** | Client persistence to be used - memory or file. | memory | PahoMqtt5Persistence |
