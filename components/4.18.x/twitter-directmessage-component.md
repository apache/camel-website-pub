...
>
> When using the Direct Message consumer, it will consider only the last 30-day direct messages
...
| Name | Description | Default | Type |
| --- | --- | --- | --- |
| **CamelTwitterUser** (common) Constant: [`TWITTER_USER`](https://javadoc.io/doc/org.apache.camel/camel-twitter/latest/org/apache/camel/component/twitter/TwitterConstants.html#TWITTER_USER) | The user. |  | String |
...
When using twitter-directmessage with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
