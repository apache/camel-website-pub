...
The Mail Microsoft OAuth2 provides an authenticator usable by [Mail](../mail-component.md) component. Importing `camel-mail-microsoft-oauth` it will automatically import the `camel-mail` component.
