...
| **camel.dataformat.avro-jackson.schema-resolver** | Optional schema resolver used to lookup schemas for the data in transit. The option is a org.apache.camel.component.jackson.SchemaResolver type. |  | String |
