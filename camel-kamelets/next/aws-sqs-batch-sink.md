...
| --- | --- | --- | --- | --- | --- |
| **batchSeparator** | Batch Separator | **Required** The batch separator string. | string |  | , |
...
[https://github.com/apache/camel-kamelets/blob/main/kamelets/aws-sqs-batch-sink.kamelet.yaml](https://github.com/apache/camel-kamelets/blob/main/kamelets/aws-sqs-batch-sink.kamelet.yaml)