...
| --- | --- | --- | --- | --- | --- |
| **queueNameOrArn** | Queue Name | **Required** The SQS Queue name or or Amazon Resource Name (ARN). | string |  |  |
...
[https://github.com/apache/camel-kamelets/blob/main/kamelets/aws-sqs-sink.kamelet.yaml](https://github.com/apache/camel-kamelets/blob/main/kamelets/aws-sqs-sink.kamelet.yaml)