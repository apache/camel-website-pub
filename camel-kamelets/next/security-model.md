...
| `script/` helper scripts, `crds/` Go client generator, `tests/camel-kamelets-itest` (Citrus), `templates/` (init `.vm` and Pipe examples) | CI, documentation generation, test and scaffolding code. Not shipped to a runtime. | No - unsupported / build / examples |
