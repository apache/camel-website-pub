...
| **streamName** | Stream Name | **Required** The name of the stream we want to send to data to. | string |  |  |
...
[https://github.com/apache/camel-kamelets/blob/main/kamelets/aws-kinesis-firehose-sink.kamelet.yaml](https://github.com/apache/camel-kamelets/blob/main/kamelets/aws-kinesis-firehose-sink.kamelet.yaml)